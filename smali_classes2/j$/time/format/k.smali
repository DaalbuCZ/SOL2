...
.method public b(Lj$/time/format/s;Ljava/lang/CharSequence;I)I
    ...
    :goto_0
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/s;->n(Lj$/time/temporal/o;JII)I
    ...
    invoke-direct {p0, v3, v2, v7, v2}, Lj$/time/format/k;->c([IILjava/lang/CharSequence;Z)Z
    ...
    :goto_3
    invoke-direct {p0, v3, v6, v7, v4}, Lj$/time/format/k;->c([IILjava/lang/CharSequence;Z)Z

    move-result v4

    if-nez v4, :cond_7

    invoke-direct {p0, v3, v10, v7, v5}, Lj$/time/format/k;->c([IILjava/lang/CharSequence;Z)Z

...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lj$/time/format/y;->h:Lj$/time/p;
...
.method private a(Lj$/time/temporal/TemporalAccessor;)V
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/o;)Z
    ...
    :try_start_0
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->k(Lj$/time/temporal/o;)J
...
.method private p()V
    ...
    :goto_0
    invoke-direct {p0, v0}, Lj$/time/format/y;->q(Lj$/time/ZoneId;)V
...
.method private q(Lj$/time/ZoneId;)V
    ...
    iget-object v2, p0, Lj$/time/format/y;->c:Lj$/time/chrono/f;
    ...
    .line 1
    invoke-static {v0, p1}, Lj$/time/ZonedDateTime;->q(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/ZonedDateTime;

    move-result-object p1

    .line 2
    invoke-virtual {p1}, Lj$/time/ZonedDateTime;->u()Lj$/time/chrono/b;

    move-result-object v0

    invoke-direct {p0, v0}, Lj$/time/format/y;->u(Lj$/time/chrono/b;)V

    sget-object v0, Lj$/time/temporal/a;->SECOND_OF_DAY:Lj$/time/temporal/a;

    invoke-virtual {p1}, Lj$/time/ZonedDateTime;->d()Lj$/time/l;
    ...
    invoke-direct {p0, v1, v0, p1}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
...
.method private r(JJJJ)V
    ...
    invoke-static {p3, p4, v0, v1}, Lj$/time/c;->d(JJ)J

    move-result-wide p3

    invoke-static {p1, p2, p3, p4}, Lj$/time/c;->a(JJ)J

    move-result-wide p1

    const-wide/32 p3, 0x3b9aca00

    invoke-static {p5, p6, p3, p4}, Lj$/time/c;->d(JJ)J
    ...
    invoke-static {p1, p2, p7, p8}, Lj$/time/c;->a(JJ)J
    ...
    invoke-static {p1, p2}, Lj$/time/l;->y(J)Lj$/time/l;

    move-result-object p1

    invoke-static {p5}, Lj$/time/p;->d(I)Lj$/time/p;

    move-result-object p2

    :goto_0
    invoke-direct {p0, p1, p2}, Lj$/time/format/y;->t(Lj$/time/l;Lj$/time/p;)V
    ...
    invoke-static {p2}, Lj$/time/p;->d(I)Lj$/time/p;
    ...
    invoke-static {p1, p3, p2, p4}, Lj$/time/l;->x(IIII)Lj$/time/l;
...
.method private s()V
    ...
    :cond_0
    invoke-virtual {v1, v4, v5}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {p0, v1, v0, v4}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    :cond_4
    invoke-virtual {v1, v6, v7}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {p0, v1, v0, v2}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-static {v6, v7, v4, v5}, Lj$/time/c;->d(JJ)J

    move-result-wide v2

    invoke-static {v2, v3, v8, v9}, Lj$/time/c;->a(JJ)J
    ...
    invoke-virtual {v2, v6, v7}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {p0, v1, v0, v6}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v0, v8}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-virtual {v1, v8, v9}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {p0, v1, v0, v10}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-virtual {v1, v2, v3}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-virtual {v9, v10, v11}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {p0, v9, v1, v0}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-virtual {v6, v9, v10}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {p0, v6, v1, v0}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v5 .. v13}, Lj$/time/format/y;->r(JJJJ)V

    :cond_19
    return-void
.end method

.method private t(Lj$/time/l;Lj$/time/p;)V
    .locals 3

    iget-object v0, p0, Lj$/time/format/y;->g:Lj$/time/l;
    ...
    iget-object p1, p0, Lj$/time/format/y;->h:Lj$/time/p;

    invoke-virtual {p1}, Lj$/time/p;->c()Z

    move-result p1

    if-nez p1, :cond_3

    invoke-virtual {p2}, Lj$/time/p;->c()Z
    ...
    iget-object v2, p0, Lj$/time/format/y;->h:Lj$/time/p;
    ...
    iget-object v2, p0, Lj$/time/format/y;->g:Lj$/time/l;
    ...
    :cond_2
    iput-object p1, p0, Lj$/time/format/y;->g:Lj$/time/l;

    :cond_3
    :goto_0
    iput-object p2, p0, Lj$/time/format/y;->h:Lj$/time/p;

    return-void
.end method

.method private u(Lj$/time/chrono/b;)V
    .locals 3
    ...
    iget-object v0, p0, Lj$/time/format/y;->c:Lj$/time/chrono/f;
    ...
    iget-object v1, p0, Lj$/time/format/y;->c:Lj$/time/chrono/f;
...
.method private v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    .locals 5
...
# virtual methods
.method public synthetic g(Lj$/time/temporal/o;)I
    .locals 0
...
.method public h(Lj$/time/temporal/o;)Z
    ...
    invoke-virtual {v0, p1}, Lj$/time/h;->h(Lj$/time/temporal/o;)Z
    ...
    invoke-virtual {v0, p1}, Lj$/time/l;->h(Lj$/time/temporal/o;)Z
...
.method public synthetic i(Lj$/time/temporal/o;)Lj$/time/temporal/z;
    .locals 0
...
.method public m(Lj$/time/temporal/w;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lj$/time/format/y;->c:Lj$/time/chrono/f;
    ...
    iget-object p1, p0, Lj$/time/format/y;->g:Lj$/time/l;
...
.method o(Lj$/time/format/z;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    .locals 18
    ...
    .line 1
    invoke-direct/range {p0 .. p0}, Lj$/time/format/y;->p()V

    .line 2
    iget-object v0, v9, Lj$/time/format/y;->c:Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/chrono/g;->g(Ljava/util/Map;Lj$/time/format/z;)Lj$/time/chrono/b;

    move-result-object v0

    invoke-direct {v9, v0}, Lj$/time/format/y;->u(Lj$/time/chrono/b;)V

    .line 3
    invoke-direct/range {p0 .. p0}, Lj$/time/format/y;->s()V
    ...
    invoke-interface {v3, v4, v9, v5}, Lj$/time/temporal/o;->a(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/z;)Lj$/time/temporal/TemporalAccessor;
    ...
    :goto_1
    invoke-interface {v4}, Lj$/time/chrono/ChronoZonedDateTime;->f()Lj$/time/chrono/c;
    ...
    invoke-virtual {v4}, Lj$/time/LocalDateTime;->d()Lj$/time/l;

    move-result-object v1

    sget-object v2, Lj$/time/p;->d:Lj$/time/p;

    invoke-direct {v9, v1, v2}, Lj$/time/format/y;->t(Lj$/time/l;Lj$/time/p;)V

    invoke-virtual {v4}, Lj$/time/LocalDateTime;->L()Lj$/time/chrono/b;

    move-result-object v1

    invoke-direct {v9, v1}, Lj$/time/format/y;->u(Lj$/time/chrono/b;)V
    ...
    invoke-direct {v9, v4}, Lj$/time/format/y;->u(Lj$/time/chrono/b;)V
    ...
    invoke-direct {v9, v4, v1}, Lj$/time/format/y;->t(Lj$/time/l;Lj$/time/p;)V
    ...
    :cond_b
    :goto_4
    iget-object v0, v9, Lj$/time/format/y;->g:Lj$/time/l;
    ...
    invoke-direct {v9, v3, v6, v2}, Lj$/time/format/y;->v(Lj$/time/temporal/o;Lj$/time/temporal/o;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v8}, Lj$/time/format/y;->r(JJJJ)V
    ...
    invoke-interface {v2}, Lj$/time/temporal/o;->g()Z
    ...
    invoke-virtual {v2, v3, v4}, Lj$/time/temporal/a;->o(J)J
    ...
    invoke-direct {v9, v0}, Lj$/time/format/y;->a(Lj$/time/temporal/TemporalAccessor;)V
    ...
    iget-object v1, v9, Lj$/time/format/y;->g:Lj$/time/l;
    ...
    iget-object v0, v9, Lj$/time/format/y;->h:Lj$/time/p;

    invoke-virtual {v0}, Lj$/time/p;->c()Z
    ...
    iget-object v1, v9, Lj$/time/format/y;->h:Lj$/time/p;
    ...
    .line 11
    instance-of v2, v1, Lj$/time/p;

    if-eqz v2, :cond_19

    invoke-virtual {v1}, Lj$/time/p;->e()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lj$/time/h;->D(J)Lj$/time/h;

    move-result-object v0

    invoke-virtual {v1}, Lj$/time/p;->b()I

    move-result v1

    int-to-long v1, v1

    invoke-virtual {v0, v1, v2}, Lj$/time/h;->C(J)Lj$/time/h;
    ...
    .line 13
    invoke-virtual {v1, v0}, Lj$/time/p;->a(Lj$/time/temporal/k;)Lj$/time/temporal/k;
    ...
    iput-object v0, v9, Lj$/time/format/y;->h:Lj$/time/p;
    ...
    iget-object v2, v9, Lj$/time/format/y;->g:Lj$/time/l;

    check-cast v1, Lj$/time/h;

    .line 21
    invoke-static {v1, v2}, Lj$/time/LocalDateTime;->D(Lj$/time/h;Lj$/time/l;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v0, v1}, Lj$/time/ZonedDateTime;->k(Lj$/time/temporal/o;)J
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lj$/time/format/y;->g:Lj$/time/l;

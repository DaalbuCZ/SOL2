...
public final class v {
    ...
    private static final ArrayList<a> f12343a = new ArrayList<>();

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f12344b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    private static String e(String str) {
        int size = f12343a.size();
        for (int i10 = 0; i10 < size; i10++) {
            a aVar = f12343a.get(i10);
            if (str.startsWith(aVar.f12346b)) {
                return aVar.f12345a;
            }
        }
        return null;
    ...
    static b i(String str) {
        Matcher matcher = f12344b.matcher(str);
        if (matcher.matches()) {

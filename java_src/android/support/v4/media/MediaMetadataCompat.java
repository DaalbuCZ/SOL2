...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final m.a<String, Integer> f336p;

    /* renamed from: q  reason: collision with root package name */
    private static final String[] f337q;

    /* renamed from: r  reason: collision with root package name */
    private static final String[] f338r;

    /* renamed from: s  reason: collision with root package name */
    private static final String[] f339s;

    /* renamed from: n  reason: collision with root package name */
    final Bundle f340n;

    /* renamed from: o  reason: collision with root package name */
    private MediaMetadata f341o;
    ...
    static {
        ...
        f337q = new String[]{"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
        f338r = new String[]{"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};
        f339s = new String[]{"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
        CREATOR = new a();
    }

    MediaMetadataCompat(Parcel parcel) {
        this.f340n = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public static MediaMetadataCompat a(Object obj) {
        ...
        obtain.recycle();
        createFromParcel.f341o = mediaMetadata;

...
public class FlutterJNI {
    ...
    private z7.a deferredComponentManager;
    private m8.a localizationPlugin;
    ...
    private final Set<j8.b> flutterUiDisplayListeners = new CopyOnWriteArraySet();
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, final long j10) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                ...
                x7.b.c(TAG, "Failed to decode image", e10);
            }
        }
        return null;
    }
    ...
    public void addIsDisplayingFlutterUiListener(j8.b bVar) {
        ensureRunningOnMainThread();
    ...
    public void dispatchEmptyPlatformMessage(String str, int i10) {
        ...
        x7.b.g(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i10);
    }
    ...
    public void dispatchPlatformMessage(String str, ByteBuffer byteBuffer, int i10, int i11) {
        ...
        x7.b.g(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i11);
    }
    ...
    public void dispatchSemanticsAction(int i10, c.g gVar, Object obj) {
        ...
        ensureAttachedToNative();
        if (obj != null) {
            byteBuffer = r.f11223a.a(obj);
            i11 = byteBuffer.position();
        } else {
            byteBuffer = null;
            i11 = 0;
        }
        dispatchSemanticsAction(i10, gVar.f9342n, byteBuffer, i11);
    }
    ...
    public void init(Context context, String[] strArr, String str, String str2, String str3, long j10) {
        if (initCalled) {
            x7.b.g(TAG, "FlutterJNI.init called more than once");
        }
    ...
    public void invokePlatformMessageEmptyResponseCallback(int i10) {
        ...
        try {
            if (isAttached()) {
                ...
                x7.b.g(TAG, "Tried to send a platform message response, but FlutterJNI was detached from native C++. Could not send. Response ID: " + i10);
            }
        } finally {
    ...
    public void loadLibrary() {
        if (loadLibraryCalled) {
            x7.b.g(TAG, "FlutterJNI.loadLibrary called more than once");
        }
    ...
    public void onFirstFrame() {
        ensureRunningOnMainThread();
        for (j8.b bVar : this.flutterUiDisplayListeners) {
            bVar.g();
        }
    }
    ...
    public void prefetchDefaultFontManager() {
        if (prefetchDefaultFontManagerCalled) {
            x7.b.g(TAG, "FlutterJNI.prefetchDefaultFontManager called more than once");
        }
    ...
    public void removeIsDisplayingFlutterUiListener(j8.b bVar) {
        ensureRunningOnMainThread();
        this.flutterUiDisplayListeners.remove(bVar);
    }

    public void requestDartDeferredLibrary(int i10) {
        z7.a aVar = this.deferredComponentManager;
        if (aVar != null) {
            aVar.f(i10, null);
        } else {
            x7.b.b(TAG, "No DeferredComponentManager found. Android setup must be completed before using split AOT deferred components.");
        }
    }
    ...
    public void setDeferredComponentManager(z7.a aVar) {
        ensureRunningOnMainThread();
    ...
    public void setLocalizationPlugin(m8.a aVar) {
        ensureRunningOnMainThread();
    ...
    public FlutterJNI spawn(String str, String str2, String str3, List<String> list) {
        ...
        w8.c.a((l10 == null || l10.longValue() == 0) ? false : true, "Failed to spawn new JNI connected shell from existing shell.");
        return nativeSpawn;
    }

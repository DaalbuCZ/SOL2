...
public final class n {
    ...
    public String a(String str, long j10, int i10, long j11) {
        ...
        int i11 = 0;
        while (true) {
            int i12 = this.f16954d;
            if (i11 >= i12) {
                sb.append(this.f16951a[i12]);
                return sb.toString();
            }
            sb.append(this.f16951a[i11]);
            int[] iArr = this.f16952b;
            if (iArr[i11] == 1) {
                sb.append(str);
            } else {
                if (iArr[i11] == 2) {
                    format = String.format(Locale.US, this.f16953c[i11], Long.valueOf(j10));
                } else if (iArr[i11] == 3) {
                    format = String.format(Locale.US, this.f16953c[i11], Integer.valueOf(i10));
                } else if (iArr[i11] == 4) {
                    format = String.format(Locale.US, this.f16953c[i11], Long.valueOf(j11));
                }
                sb.append(format);
            }
            i11++;

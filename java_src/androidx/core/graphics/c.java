...
public class c {
    ...
    public static class b {
        ...
        b(b bVar) {
            ...
            float[] fArr = bVar.f1401b;
            this.f1401b = c.c(fArr, 0, fArr.length);
        }
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                a(path, fArr, c10, bVarArr[i10].f1400a, bVarArr[i10].f1401b);
                c10 = bVarArr[i10].f1400a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f10) {
            ...
            while (true) {
                ...
                this.f1401b[i10] = (fArr[i10] * (1.0f - f10)) + (bVar2.f1401b[i10] * f10);
                i10++;
            }
        }
    }
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f1400a != bVarArr2[i10].f1400a || bVarArr[i10].f1401b.length != bVarArr2[i10].f1401b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f1400a = bVarArr2[i10].f1400a;
            for (int i11 = 0; i11 < bVarArr2[i10].f1401b.length; i11++) {
                bVarArr[i10].f1401b[i11] = bVarArr2[i10].f1401b[i11];
            }
        }
    }
}

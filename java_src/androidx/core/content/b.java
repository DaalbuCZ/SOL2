...
public class b extends ContentProvider {
    ...
    private static final String[] f1329p = {"_display_name", "_size"};

    /* renamed from: q  reason: collision with root package name */
    private static final File f1330q = new File("/");

    /* renamed from: r  reason: collision with root package name */
    private static final HashMap<String, InterfaceC0021b> f1331r = new HashMap<>();

    /* renamed from: n  reason: collision with root package name */
    private InterfaceC0021b f1332n;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public static class c implements InterfaceC0021b {

        /* renamed from: a  reason: collision with root package name */
        private final String f1334a;

        /* renamed from: b  reason: collision with root package name */
        private final HashMap<String, File> f1335b = new HashMap<>();

        c(String str) {
            this.f1334a = str;
        }

        @Override // androidx.core.content.b.InterfaceC0021b
        public File a(Uri uri) {
            String encodedPath = uri.getEncodedPath();
            int indexOf = encodedPath.indexOf(47, 1);
            String decode = Uri.decode(encodedPath.substring(1, indexOf));
            String decode2 = Uri.decode(encodedPath.substring(indexOf + 1));
            File file = this.f1335b.get(decode);
            if (file == null) {
        ...
        public Uri b(File file) {
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f1335b.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f1334a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(substring, "/")).build();
            } catch (IOException unused) {
        ...
        void c(String str, File file) {
            ...
            try {
                this.f1335b.put(str, file.getCanonicalFile());
    ...
    private static InterfaceC0021b e(Context context, String str, int i10) {
        InterfaceC0021b interfaceC0021b;
        HashMap<String, InterfaceC0021b> hashMap = f1331r;
        synchronized (hashMap) {
            interfaceC0021b = hashMap.get(str);
            if (interfaceC0021b == null) {
                try {
                    try {
                        interfaceC0021b = h(context, str, i10);
                        hashMap.put(str, interfaceC0021b);
    ...
    private static InterfaceC0021b h(Context context, String str, int i10) {
        c cVar = new c(str);
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f1332n = e(context, str, this.f1333o);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f1332n.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File a10 = this.f1332n.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) {
        return ParcelFileDescriptor.open(this.f1332n.a(uri), g(str));
    }

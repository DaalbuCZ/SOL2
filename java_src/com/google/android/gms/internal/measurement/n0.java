...
public enum n0 {
    ...
    static {
        n0[] values;
        for (n0 n0Var : values()) {
            C0.put(Integer.valueOf(n0Var.f4024n), n0Var);
        }
    }
    ...
    public static n0 e(int i10) {
        return (n0) C0.get(Integer.valueOf(i10));
    }

    public final Integer g() {
        return Integer.valueOf(this.f4024n);
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f4024n).toString();
    }
}

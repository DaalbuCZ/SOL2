...
public final class b extends q8 {
    ...
    private final q9 n(Integer num) {
        if (this.f4411f.containsKey(num)) {
            return (q9) this.f4411f.get(num);
        }
        q9 q9Var = new q9(this, this.f4409d, null);
        this.f4411f.put(num, q9Var);
        return q9Var;
    }

    private final boolean o(int i10, int i11) {
        q9 q9Var = (q9) this.f4411f.get(Integer.valueOf(i10));
        if (q9Var == null) {
            return false;
        }
        return q9.b(q9Var).get(i11);
    }

...
public class j0 {
    ...
    private final Bundle f5556a;

    public j0(Bundle bundle) {
        Objects.requireNonNull(bundle, "data");
        this.f5556a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f5556a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f5556a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f5556a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f5556a);
        for (String str : this.f5556a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }

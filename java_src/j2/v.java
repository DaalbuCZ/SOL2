...
public final class v {
    ...
    private static final Pattern f10366a = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap<b, List<n>> f10367b = new HashMap<>();
    ...
    public static final class b {
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            return TextUtils.equals(this.f10369a, bVar.f10369a) && this.f10370b == bVar.f10370b && this.f10371c == bVar.f10371c;
        }

        public int hashCode() {
            return ((((this.f10369a.hashCode() + 31) * 31) + (this.f10370b ? 1231 : 1237)) * 31) + (this.f10371c ? 1231 : 1237);
        }
    }
    ...
    public static final class f implements d {
        ...
        /* renamed from: b  reason: collision with root package name */
        private MediaCodecInfo[] f10373b;

        public f(boolean z10, boolean z11) {
            this.f10372a = (z10 || z11) ? 1 : 0;
        }

        @EnsuresNonNull({"mediaCodecInfos"})
        private void f() {
            if (this.f10373b == null) {
                this.f10373b = new MediaCodecList(this.f10372a).getCodecInfos();
            }
        }
    ...
    private static boolean A(MediaCodecInfo mediaCodecInfo) {
        return m0.f12306a >= 29 && B(mediaCodecInfo);
    }
    ...
    private static boolean C(MediaCodecInfo mediaCodecInfo, String str, boolean z10, String str2) {
        ...
        if (i10 >= 21 || !("CIPAACDecoder".equals(str) || "CIPMP3Decoder".equals(str) || "CIPVorbisDecoder".equals(str) || "CIPAMRNBDecoder".equals(str) || "AACDecoder".equals(str) || "MP3Decoder".equals(str))) {
            if (i10 < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
                ...
                if ("a70".equals(str3) || ("Xiaomi".equals(m0.f12308c) && str3.startsWith("HM"))) {
                    return false;
                }
            }
            if (i10 == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
                String str4 = m0.f12307b;
                if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                    return false;
                }
            }
            if (i10 == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
                String str5 = m0.f12307b;
                if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                    return false;
                }
            }
            if (i10 < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(m0.f12308c))) {
                String str6 = m0.f12307b;
                if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                    return false;
                }
            }
            if (i10 <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(m0.f12308c)) {
                String str7 = m0.f12307b;
                if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                    return false;
                }
            }
            if (i10 <= 19 && m0.f12307b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
                return false;
            }
    ...
    private static boolean D(MediaCodecInfo mediaCodecInfo, String str) {
        return m0.f12306a >= 29 ? E(mediaCodecInfo) : !F(mediaCodecInfo, str);
    }
    ...
    private static boolean F(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String e10 = a5.b.e(mediaCodecInfo.getName());
    ...
    public static /* synthetic */ int J(n nVar) {
        ...
        return (m0.f12306a >= 26 || !str.equals("OMX.MTK.AUDIO.DECODER.RAW")) ? 0 : -1;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ int K(n nVar) {
        return nVar.f10318a.startsWith("OMX.google") ? 1 : 0;
    }
    ...
    public static int N() {
        if (f10368c == -1) {
            ...
            if (r10 != null) {
                ...
                i10 = Math.max(i11, m0.f12306a >= 21 ? 345600 : 172800);
            }
            f10368c = i10;
        }
        return f10368c;
    ...
    private static void e(String str, List<n> list) {
        if ("audio/raw".equals(str)) {
            if (m0.f12306a < 26 && m0.f12307b.equals("R9") && list.size() == 1 && list.get(0).f10318a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
        ...
        if (i10 < 21 && list.size() > 1) {
            String str2 = list.get(0).f10318a;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                P(list, t.f10364a);
            }
        }
        if (i10 >= 32 || list.size() <= 1 || !"OMX.qti.audio.decoder.flac".equals(list.get(0).f10318a)) {
            return;
        }
    ...
    public static String m(m1 m1Var) {
        ...
        if ("audio/eac3-joc".equals(m1Var.f13587y)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(m1Var.f13587y) || (q10 = q(m1Var)) == null) {
            return null;
        }
    ...
    private static Pair<Integer, Integer> n(String str, String[] strArr, q3.c cVar) {
        ...
        if (strArr.length >= 4) {
            ...
            if (parseInt != 0) {
                ...
                int i11 = parseInt3 != 8 ? (cVar == null || !(cVar.f12568q != null || (i10 = cVar.f12567p) == 7 || i10 == 6)) ? 2 : 4096 : 1;
                int f10 = f(parseInt2);
                if (f10 != -1) {
    ...
    */
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> q(s1.m1 r6) {
        /*
            java.lang.String r0 = r6.f13584v
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            ...
            java.lang.String r2 = r6.f13587y
            java.lang.String r3 = "video/dolby-vision"
            boolean r2 = r3.equals(r2)
            if (r2 == 0) goto L1d
            java.lang.String r6 = r6.f13584v
        ...
        L91:
            ...
            return r6
        L98:
            java.lang.String r1 = r6.f13584v
            q3.c r6 = r6.K
            android.util.Pair r6 = n(r1, r0, r6)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: j2.v.q(s1.m1):android.util.Pair");
    }
    ...
    public static synchronized List<n> s(String str, boolean z10, boolean z11) {
        synchronized (v.class) {
            ...
            HashMap<b, List<n>> hashMap = f10367b;
            ...
            if (z10 && t10.isEmpty() && 21 <= i10 && i10 <= 23) {
                t10 = t(bVar, new e());
                if (!t10.isEmpty()) {
                    p3.r.i("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + t10.get(0).f10318a);
                }
            }
            e(str, t10);
            b5.q F = b5.q.F(t10);
    ...
    */
    ...
    private static Pair<Integer, Integer> w(String str, String[] strArr) {
        ...
        if (strArr.length < 3) {
            ...
            Matcher matcher = f10366a.matcher(strArr[1]);
            if (matcher.matches()) {
                str = matcher.group(1);
                Integer k10 = k(str);
                if (k10 == null) {

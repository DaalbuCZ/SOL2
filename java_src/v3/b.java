...
public abstract class b extends BroadcastReceiver {
    ...
    private final ExecutorService f15586a;

    public b() {
        k4.e.a();
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(1, 1, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new e4.a("firebase-iid-executor"));
        threadPoolExecutor.allowCoreThreadTimeOut(true);
        this.f15586a = Executors.unconfigurableExecutorService(threadPoolExecutor);
    }
    ...
    private final int e(Context context, Intent intent) {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            ...
            c10 = x.b(context).c(2, bundle);
        }
        int b10 = b(context, new a(intent));
        try {
            t4.l.b(c10, TimeUnit.SECONDS.toMillis(1L), TimeUnit.MILLISECONDS);
    ...
    public final void onReceive(final Context context, final Intent intent) {
        ...
        a().execute(new Runnable() { // from class: v3.j

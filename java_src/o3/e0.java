...
public final class e0 {
    ...
    private static final Pattern f11946a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f11947b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L28:
            ...
            if (r0 != 0) goto La4
            java.util.regex.Pattern r0 = o3.e0.f11946a
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f11947b.matcher(str);
        if (matcher.matches()) {

...
public abstract class f<K, V> {
    ...
    final class a<T> implements Iterator<T>, j$.util.Iterator {
        ...
        boolean f11268q = false;

        a(int i10) {
            this.f11265n = i10;
            this.f11266o = f.this.d();
        }
        ...
        public boolean hasNext() {
            return this.f11267p < this.f11266o;
        }

        @Override // java.util.Iterator, j$.util.Iterator
        public T next() {
            if (hasNext()) {
                T t10 = (T) f.this.b(this.f11267p, this.f11265n);
                this.f11267p++;
                this.f11268q = true;
                return t10;
            }
    ...
    public final class b implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            if (obj instanceof Map.Entry) {
                ...
                return m.c.c(f.this.b(e10, 1), entry.getValue());
            }
            return false;
        }
    ...
    final class d implements java.util.Iterator<Map.Entry<K, V>>, Map.Entry<K, V>, j$.util.Iterator, Map.Entry {
        ...
        /* renamed from: p  reason: collision with root package name */
        boolean f11274p = false;

        /* renamed from: o  reason: collision with root package name */
        int f11273o = -1;

        d() {
            this.f11272n = f.this.d() - 1;
        }
        ...
        public boolean equals(Object obj) {
            if (this.f11274p) {
                if (obj instanceof Map.Entry) {
                    Map.Entry entry = (Map.Entry) obj;
                    return m.c.c(entry.getKey(), f.this.b(this.f11273o, 0)) && m.c.c(entry.getValue(), f.this.b(this.f11273o, 1));
                }
                return false;
            }
        ...
        public K getKey() {
            if (this.f11274p) {
                return (K) f.this.b(this.f11273o, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public V getValue() {
            if (this.f11274p) {
                return (V) f.this.b(this.f11273o, 1);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        @Override // java.util.Iterator, j$.util.Iterator
        public boolean hasNext() {
            return this.f11273o < this.f11272n;
        }

        @Override // java.util.Map.Entry, j$.util.Map.Entry
        public int hashCode() {
            if (this.f11274p) {
                Object b10 = f.this.b(this.f11273o, 0);
                Object b11 = f.this.b(this.f11273o, 1);
        ...
        public V setValue(V v10) {
            if (this.f11274p) {
                return (V) f.this.i(this.f11273o, v10);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }

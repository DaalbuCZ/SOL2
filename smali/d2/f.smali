...
.method private a(Lx1/m;)J
    ...
    invoke-interface {p1, v3, v2, v4}, Lx1/m;->o([BII)V
...
.method public b(Lx1/m;)Z
    ...
    iget-object v4, p0, Ld2/f;->a:Lp3/a0;
    ...
    invoke-interface {p1, v4, v5, v6}, Lx1/m;->o([BII)V

    iget-object v4, p0, Ld2/f;->a:Lp3/a0;

    invoke-virtual {v4}, Lp3/a0;->E()J

    move-result-wide v7

    iput v6, p0, Ld2/f;->b:I
    ...
    iget v4, p0, Ld2/f;->b:I

    add-int/2addr v4, v6

    iput v4, p0, Ld2/f;->b:I
    ...
    :cond_3
    invoke-direct {p0, p1}, Ld2/f;->a(Lx1/m;)J

    move-result-wide v3

    iget v7, p0, Ld2/f;->b:I

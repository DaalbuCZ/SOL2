...
.method public static a(Landroid/content/Context;Ll0/i;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->y()Ls0/h;

    move-result-object p1

    invoke-interface {p1, p2}, Ls0/h;->c(Ljava/lang/String;)Ls0/g;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lk0/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-interface {p1, p2}, Ls0/h;->d(Ljava/lang/String;)V
...
.method private static b(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v2, p1, p2}, Lk0/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public static c(Landroid/content/Context;Ll0/i;Ljava/lang/String;J)V
    .locals 2
    ...
    invoke-interface {v0, p2}, Ls0/h;->c(Ljava/lang/String;)Ls0/g;

    move-result-object v1

    if-eqz v1, :cond_0

    iget p1, v1, Ls0/g;->b:I
    ...
    invoke-direct {v1, p1}, Lt0/c;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    invoke-direct {v1, p2, p1}, Ls0/g;-><init>(Ljava/lang/String;I)V

    invoke-interface {v0, v1}, Ls0/h;->a(Ls0/g;)V

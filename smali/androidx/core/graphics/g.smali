...
.method public constructor <init>()V
    ...
    :try_start_0
    invoke-virtual {p0}, Landroidx/core/graphics/g;->z()Ljava/lang/Class;
    ...
    invoke-virtual {p0, v1}, Landroidx/core/graphics/g;->y(Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method public b(Landroid/content/Context;Landroidx/core/content/res/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-direct {p0}, Landroidx/core/graphics/g;->u()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2, p3, p4}, Landroidx/core/graphics/e;->b(Landroid/content/Context;Landroidx/core/content/res/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-direct {p0}, Landroidx/core/graphics/g;->p()Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/core/graphics/g;->r(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;III[Landroid/graphics/fonts/FontVariationAxis;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-direct {p0, p3}, Landroidx/core/graphics/g;->q(Ljava/lang/Object;)V
    ...
    :cond_3
    invoke-direct {p0, p3}, Landroidx/core/graphics/g;->t(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-virtual {p0, p3}, Landroidx/core/graphics/g;->m(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;I)Landroid/graphics/Typeface;
    ...
    invoke-direct/range {v3 .. v8}, Landroidx/core/graphics/g;->s(Ljava/lang/Object;Ljava/nio/ByteBuffer;III)Z

    move-result v3

    if-nez v3, :cond_6

    invoke-direct {p0, p2}, Landroidx/core/graphics/g;->q(Ljava/lang/Object;)V
    ...
    :cond_8
    invoke-direct {p0, p2}, Landroidx/core/graphics/g;->t(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-virtual {p0, p2}, Landroidx/core/graphics/g;->m(Ljava/lang/Object;)Landroid/graphics/Typeface;

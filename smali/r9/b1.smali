...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lr9/b1;->s:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lr9/b1;->t:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lr9/c1;-><init>()V

    const/4 v0, 0x0

    iput-object v0, p0, Lr9/b1;->_queue:Ljava/lang/Object;

    iput-object v0, p0, Lr9/b1;->_delayed:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lr9/b1;->_isCompleted:I

    return-void
.end method

.method public static final synthetic k0(Lr9/b1;)Z
    .locals 0

    invoke-direct {p0}, Lr9/b1;->p0()Z
...
.method private final l0()V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lr9/b1;->_queue:Ljava/lang/Object;

    if-nez v0, :cond_2

    sget-object v0, Lr9/b1;->s:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    const/4 v1, 0x0

    invoke-static {}, Lr9/e1;->a()Lkotlinx/coroutines/internal/e0;
    ...
    sget-object v2, Lr9/b1;->s:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method private final o0(Ljava/lang/Runnable;)Z
    ...
    :cond_4
    sget-object v1, Lr9/b1;->s:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sget-object v3, Lr9/b1;->s:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method private final p0()Z
    ...
    iget v0, p0, Lr9/b1;->_isCompleted:I
...
.method private final s0()V
    ...
    :goto_0
    iget-object v2, p0, Lr9/b1;->_delayed:Ljava/lang/Object;

    check-cast v2, Lr9/b1$b;
    ...
    :cond_0
    invoke-virtual {p0, v0, v1, v2}, Lr9/c1;->i0(JLr9/b1$a;)V
...
.method private final v0(JLr9/b1$a;)I
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, Lr9/b1;->_delayed:Ljava/lang/Object;

    check-cast v0, Lr9/b1$b;

    if-nez v0, :cond_1

    sget-object v0, Lr9/b1;->t:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    const/4 v1, 0x0

    new-instance v2, Lr9/b1$b;

    invoke-direct {v2, p1, p2}, Lr9/b1$b;-><init>(J)V
    ...
    :cond_1
    invoke-virtual {p3, p1, p2, v0, p0}, Lr9/b1$a;->q(JLr9/b1$b;Lr9/b1;)I
...
.method private final w0(Z)V
    ...
    iput p1, p0, Lr9/b1;->_isCompleted:I

    return-void
.end method

.method private final x0(Lr9/b1$a;)Z
    .locals 1
...
# virtual methods
.method public final b(Lb9/g;Ljava/lang/Runnable;)V
    .locals 0

    invoke-virtual {p0, p2}, Lr9/b1;->n0(Ljava/lang/Runnable;)V
...
.method protected b0()J
    ...
    invoke-static {v0, v1, v2, v3}, Ln9/d;->b(JJ)J
...
.method public n0(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, Lr9/b1;->o0(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lr9/c1;->j0()V
    ...
    invoke-virtual {v0, p1}, Lr9/p0;->n0(Ljava/lang/Runnable;)V
...
.method public r0()J
    ...
    :cond_3
    :try_start_1
    check-cast v5, Lr9/b1$a;

    invoke-virtual {v5, v3, v4}, Lr9/b1$a;->r(J)Z
    ...
    invoke-direct {p0, v5}, Lr9/b1;->o0(Ljava/lang/Runnable;)Z
    ...
    :cond_5
    :goto_3
    invoke-direct {p0}, Lr9/b1;->m0()Ljava/lang/Runnable;
...
.method public shutdown()V
    ...
    sget-object v0, Lr9/g2;->a:Lr9/g2;

    invoke-virtual {v0}, Lr9/g2;->b()V

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lr9/b1;->w0(Z)V

    invoke-direct {p0}, Lr9/b1;->l0()V

    :cond_0
    invoke-virtual {p0}, Lr9/b1;->r0()J
...
.method public final u0(JLr9/b1$a;)V
    .locals 2

    invoke-direct {p0, p1, p2, p3}, Lr9/b1;->v0(JLr9/b1$a;)I
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lr9/c1;->i0(JLr9/b1$a;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, p3}, Lr9/b1;->x0(Lr9/b1$a;)Z

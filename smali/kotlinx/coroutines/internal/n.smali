...
# instance fields
.field private final p:Lr9/d0;

.field private final q:I

.field private final synthetic r:Lr9/r0;
...
# direct methods
.method public constructor <init>(Lr9/d0;I)V
    .locals 0

    invoke-direct {p0}, Lr9/d0;-><init>()V

    iput-object p1, p0, Lkotlinx/coroutines/internal/n;->p:Lr9/d0;

    iput p2, p0, Lkotlinx/coroutines/internal/n;->q:I

    instance-of p2, p1, Lr9/r0;

    if-eqz p2, :cond_0

    check-cast p1, Lr9/r0;
    ...
    invoke-static {}, Lr9/q0;->a()Lr9/r0;

    move-result-object p1

    :cond_1
    iput-object p1, p0, Lkotlinx/coroutines/internal/n;->r:Lr9/r0;
...
.method public b(Lb9/g;Ljava/lang/Runnable;)V
    ...
    iget-object p1, p0, Lkotlinx/coroutines/internal/n;->p:Lr9/d0;

    invoke-virtual {p1, p0, p0}, Lr9/d0;->b(Lb9/g;Ljava/lang/Runnable;)V
...
.method public run()V
    ...
    sget-object v3, Lb9/h;->n:Lb9/h;

    invoke-static {v3, v2}, Lr9/g0;->a(Lb9/g;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lkotlinx/coroutines/internal/n;->p:Lr9/d0;

    invoke-virtual {v2, p0}, Lr9/d0;->W(Lb9/g;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v0, p0, Lkotlinx/coroutines/internal/n;->p:Lr9/d0;

    invoke-virtual {v0, p0, p0}, Lr9/d0;->b(Lb9/g;Ljava/lang/Runnable;)V

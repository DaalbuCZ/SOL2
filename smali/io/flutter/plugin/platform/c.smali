...
.field private d:Lk8/i$j;

.field private e:I

.field final f:Lk8/i$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lk8/i;Lio/flutter/plugin/platform/c$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/c;->f:Lk8/i$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/c;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/c;->b:Lk8/i;

    invoke-virtual {p2, v0}, Lk8/i;->l(Lk8/i$h;)V
...
.method static synthetic a(Lio/flutter/plugin/platform/c;Lk8/i$i;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->q(Lk8/i$i;)V
...
.method static synthetic e(Lio/flutter/plugin/platform/c;)Lk8/i;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/c;->b:Lk8/i;

    return-object p0
.end method

.method static synthetic f(Lio/flutter/plugin/platform/c;Lk8/i$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->u(Lk8/i$c;)V
...
.method static synthetic h(Lio/flutter/plugin/platform/c;Lk8/i$k;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->w(Lk8/i$k;)V
...
.method static synthetic k(Lio/flutter/plugin/platform/c;Lk8/i$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->z(Lk8/i$j;)V
...
.method static synthetic m(Lio/flutter/plugin/platform/c;Lk8/i$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->p(Lk8/i$e;)Ljava/lang/CharSequence;
...
.method private p(Lk8/i$e;)Ljava/lang/CharSequence;
    .locals 4
    ...
    sget-object v1, Lk8/i$e;->o:Lk8/i$e;
...
.method private q(Lk8/i$i;)V
    .locals 1

    sget-object v0, Lk8/i$i;->o:Lk8/i$i;
...
.method private u(Lk8/i$c;)V
    ...
    iget-object v4, p1, Lk8/i$c;->b:Ljava/lang/String;

    const/4 v5, 0x0

    iget v6, p1, Lk8/i$c;->a:I
    ...
    iget-object v1, p1, Lk8/i$c;->b:Ljava/lang/String;

    const/4 v2, 0x0

    iget p1, p1, Lk8/i$c;->a:I
...
.method private w(Lk8/i$k;)V
    .locals 2

    sget-object v0, Lk8/i$k;->o:Lk8/i$k;
    ...
    :cond_0
    sget-object v0, Lk8/i$k;->p:Lk8/i$k;
    ...
    :cond_1
    sget-object v0, Lk8/i$k;->q:Lk8/i$k;
    ...
    :cond_2
    sget-object v0, Lk8/i$k;->r:Lk8/i$k;
...
.method private z(Lk8/i$j;)V
    ...
    iget-object v3, p1, Lk8/i$j;->b:Lk8/i$d;
    ...
    :cond_3
    :goto_0
    iget-object v3, p1, Lk8/i$j;->a:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v3, p1, Lk8/i$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Lk8/i$j;->e:Lk8/i$d;
    ...
    :cond_8
    :goto_1
    iget-object v2, p1, Lk8/i$j;->d:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Lk8/i$j;->f:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v2, p1, Lk8/i$j;->g:Ljava/lang/Boolean;
    ...
    :cond_b
    iput-object p1, p0, Lio/flutter/plugin/platform/c;->d:Lk8/i$j;
...
.method public A()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/c;->d:Lk8/i$j;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/c;->z(Lk8/i$j;)V
...
.method public o()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/c;->b:Lk8/i;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lk8/i;->l(Lk8/i$h;)V

...
.field private final d:Lk8/p;

.field private e:Lio/flutter/plugin/editing/f$c;

.field private f:Lk8/p$b;
...
.field private n:Lk8/p$e;

.field private o:Z


# direct methods
.method public constructor <init>(Landroid/view/View;Lk8/p;Lio/flutter/plugin/platform/q;)V
    .locals 4
    ...
    invoke-direct {v0, v1, p1}, Lio/flutter/plugin/editing/c;-><init>(Lk8/p$e;Landroid/view/View;)V
    ...
    :cond_3
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->d:Lk8/p;
    ...
    invoke-virtual {p2, p1}, Lk8/p;->n(Lk8/p$f;)V

    invoke-virtual {p2}, Lk8/p;->k()V
...
.method private H(Lk8/p$b;)V
    ...
    iget-object v0, p1, Lk8/p$b;->j:Lk8/p$b$a;
    ...
    :cond_1
    iget-object v0, p1, Lk8/p$b;->l:[Lk8/p$b;
    ...
    iget-object v0, v0, Lk8/p$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v2, Lk8/p$b;->j:Lk8/p$b$a;

    if-eqz v3, :cond_3

    iget-object v4, p0, Lio/flutter/plugin/editing/f;->g:Landroid/util/SparseArray;

    iget-object v5, v3, Lk8/p$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v3, Lk8/p$b$a;->c:Lk8/p$e;

    iget-object v3, v3, Lk8/p$e;->a:Ljava/lang/String;
...
.method private k()Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->f:Lk8/p$b;

    const/4 v1, 0x1

    if-eqz v0, :cond_2

    iget-object v0, v0, Lk8/p$b;->g:Lk8/p$c;
    ...
    :cond_0
    iget-object v0, v0, Lk8/p$c;->a:Lk8/p$g;

    sget-object v2, Lk8/p$g;->y:Lk8/p$g;
...
.method private static n(Lk8/p$e;Lk8/p$e;)Z
    .locals 7

    iget v0, p0, Lk8/p$e;->e:I

    iget v1, p0, Lk8/p$e;->d:I

    sub-int/2addr v0, v1

    iget v1, p1, Lk8/p$e;->e:I

    iget v2, p1, Lk8/p$e;->d:I
    ...
    iget-object v4, p0, Lk8/p$e;->a:Ljava/lang/String;

    iget v5, p0, Lk8/p$e;->d:I
    ...
    iget-object v5, p1, Lk8/p$e;->a:Ljava/lang/String;

    iget v6, p1, Lk8/p$e;->d:I
...
.method private static t(Lk8/p$c;ZZZZLk8/p$d;)I
    .locals 1

    iget-object p4, p0, Lk8/p$c;->a:Lk8/p$g;

    sget-object v0, Lk8/p$g;->p:Lk8/p$g;
    ...
    :cond_0
    sget-object v0, Lk8/p$g;->s:Lk8/p$g;

    if-ne p4, v0, :cond_3

    const/4 p1, 0x2

    iget-boolean p2, p0, Lk8/p$c;->b:Z
    ...
    :cond_1
    iget-boolean p0, p0, Lk8/p$c;->c:Z
    ...
    :cond_3
    sget-object p0, Lk8/p$g;->t:Lk8/p$g;
    ...
    :cond_4
    sget-object p0, Lk8/p$g;->y:Lk8/p$g;
    ...
    sget-object v0, Lk8/p$g;->u:Lk8/p$g;
    ...
    :cond_6
    sget-object v0, Lk8/p$g;->v:Lk8/p$g;
    ...
    :cond_7
    sget-object v0, Lk8/p$g;->w:Lk8/p$g;
    ...
    :cond_8
    sget-object v0, Lk8/p$g;->x:Lk8/p$g;
    ...
    :cond_9
    sget-object v0, Lk8/p$g;->q:Lk8/p$g;
    ...
    :cond_a
    sget-object v0, Lk8/p$g;->r:Lk8/p$g;
    ...
    :cond_e
    :goto_1
    sget-object p1, Lk8/p$d;->o:Lk8/p$d;
    ...
    :cond_f
    sget-object p1, Lk8/p$d;->p:Lk8/p$d;
    ...
    :cond_10
    sget-object p1, Lk8/p$d;->q:Lk8/p$d;
...
.method private w(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lk8/p$b;->j:Lk8/p$b$a;
...
.method D(ILk8/p$b;)V
    ...
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->f:Lk8/p$b;
    ...
    iget-object v0, p2, Lk8/p$b;->j:Lk8/p$b$a;

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    iget-object v0, v0, Lk8/p$b$a;->c:Lk8/p$e;
    ...
    invoke-direct {p1, v0, v2}, Lio/flutter/plugin/editing/c;-><init>(Lk8/p$e;Landroid/view/View;)V

    iput-object p1, p0, Lio/flutter/plugin/editing/f;->h:Lio/flutter/plugin/editing/c;

    invoke-direct {p0, p2}, Lio/flutter/plugin/editing/f;->H(Lk8/p$b;)V
...
.method E(Landroid/view/View;Lk8/p$e;)V
    .locals 2
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->n:Lk8/p$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lk8/p$e;->b()Z
    ...
    invoke-static {v0, p2}, Lio/flutter/plugin/editing/f;->n(Lk8/p$e;Lk8/p$e;)Z
    ...
    :cond_0
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->n:Lk8/p$e;

    iget-object v0, p0, Lio/flutter/plugin/editing/f;->h:Lio/flutter/plugin/editing/c;

    invoke-virtual {v0, p2}, Lio/flutter/plugin/editing/c;->n(Lk8/p$e;)V
...
.method public a(ZZZ)V
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/f;->n:Lk8/p$e;
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/f;->n:Lk8/p$e;

    iget-object v2, v2, Lk8/p$e;->a:Ljava/lang/String;
    ...
    iget v2, v1, Lk8/p$e;->b:I

    if-ne p1, v2, :cond_1

    iget v2, v1, Lk8/p$e;->c:I

    if-ne p2, v2, :cond_1

    iget v2, v1, Lk8/p$e;->d:I

    if-ne p3, v2, :cond_1

    iget v1, v1, Lk8/p$e;->e:I
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/f;->f:Lk8/p$b;

    iget-boolean v1, v1, Lk8/p$b;->e:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, Lio/flutter/plugin/editing/f;->d:Lk8/p;
    ...
    invoke-virtual {v1, v2, v0}, Lk8/p;->q(ILjava/util/ArrayList;)V
    ...
    :cond_3
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->d:Lk8/p;
    ...
    invoke-virtual/range {v0 .. v6}, Lk8/p;->p(ILjava/lang/String;IIII)V

    :goto_2
    new-instance v6, Lk8/p$e;
    ...
    invoke-direct/range {v0 .. v5}, Lk8/p$e;-><init>(Ljava/lang/String;IIII)V

    iput-object v6, p0, Lio/flutter/plugin/editing/f;->n:Lk8/p$e;
...
.method public j(Landroid/util/SparseArray;)V
    ...
    check-cast v3, Lk8/p$b;

    if-eqz v3, :cond_4

    iget-object v3, v3, Lk8/p$b;->j:Lk8/p$b$a;
    ...
    invoke-direct/range {v5 .. v10}, Lk8/p$e;-><init>(Ljava/lang/String;IIII)V

    iget-object v5, v3, Lk8/p$b$a;->a:Ljava/lang/String;

    iget-object v6, v0, Lk8/p$b$a;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lio/flutter/plugin/editing/c;->n(Lk8/p$e;)V

    goto :goto_1

    :cond_3
    iget-object v3, v3, Lk8/p$b$a;->a:Ljava/lang/String;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/plugin/editing/f;->d:Lk8/p;

    iget-object v0, p0, Lio/flutter/plugin/editing/f;->e:Lio/flutter/plugin/editing/f$c;

    iget v0, v0, Lio/flutter/plugin/editing/f$c;->b:I

    invoke-virtual {p1, v0, v1}, Lk8/p;->r(ILjava/util/HashMap;)V
...
.method m()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/f;->f:Lk8/p$b;

    invoke-direct {p0, v0}, Lio/flutter/plugin/editing/f;->H(Lk8/p$b;)V
...
.method public o(Landroid/view/View;Lio/flutter/embedding/android/s;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v1, v0, Lk8/p$b;->g:Lk8/p$c;

    iget-boolean v2, v0, Lk8/p$b;->a:Z

    iget-boolean v3, v0, Lk8/p$b;->b:Z

    iget-boolean v4, v0, Lk8/p$b;->c:Z

    iget-boolean v5, v0, Lk8/p$b;->d:Z

    iget-object v6, v0, Lk8/p$b;->f:Lk8/p$d;

    invoke-static/range {v1 .. v6}, Lio/flutter/plugin/editing/f;->t(Lk8/p$c;ZZZZLk8/p$d;)I
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/f;->f:Lk8/p$b;

    iget-boolean v2, v2, Lk8/p$b;->d:Z
    ...
    iget-object v1, v1, Lk8/p$b;->h:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Lk8/p$b;->i:Ljava/lang/String;
    ...
    iget-object v0, v1, Lk8/p$b;->k:[Ljava/lang/String;
    ...
    iget-object v4, p0, Lio/flutter/plugin/editing/f;->d:Lk8/p;
    ...
    invoke-direct/range {v1 .. v7}, Lio/flutter/plugin/editing/b;-><init>(Landroid/view/View;ILk8/p;Lio/flutter/plugin/editing/b$a;Lio/flutter/plugin/editing/c;Landroid/view/inputmethod/EditorInfo;)V
...
.method public p()V
    ...
    invoke-virtual {v0, v1}, Lk8/p;->n(Lk8/p$f;)V
...
.method public z(Landroid/view/ViewStructure;I)V
    ...
    :cond_0
    iget-object v2, v0, Lio/flutter/plugin/editing/f;->f:Lk8/p$b;

    iget-object v2, v2, Lk8/p$b;->j:Lk8/p$b$a;

    iget-object v2, v2, Lk8/p$b$a;->a:Ljava/lang/String;
    ...
    check-cast v7, Lk8/p$b;

    iget-object v7, v7, Lk8/p$b;->j:Lk8/p$b$a;
    ...
    iget-object v9, v7, Lk8/p$b$a;->b:[Ljava/lang/String;
    ...
    iget-object v8, v7, Lk8/p$b$a;->d:Ljava/lang/String;
    ...
    iget-object v6, v7, Lk8/p$b$a;->c:Lk8/p$e;

    iget-object v6, v6, Lk8/p$e;->a:Ljava/lang/String;

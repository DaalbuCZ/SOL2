...
.field private final q:Lio/flutter/plugins/imagepicker/g;

.field private final r:Lio/flutter/plugins/imagepicker/d;

.field private final s:Lio/flutter/plugins/imagepicker/e$g;

.field private final t:Lio/flutter/plugins/imagepicker/e$e;

.field private final u:Lio/flutter/plugins/imagepicker/c;

.field private v:Lio/flutter/plugins/imagepicker/a;

.field private w:Landroid/net/Uri;

.field private x:Ll8/k$d;

.field private y:Ll8/j;
...
.method public constructor <init>(Landroid/app/Activity;Ljava/io/File;Lio/flutter/plugins/imagepicker/g;Lio/flutter/plugins/imagepicker/d;)V
    ...
    invoke-direct/range {v0 .. v9}, Lio/flutter/plugins/imagepicker/e;-><init>(Landroid/app/Activity;Ljava/io/File;Lio/flutter/plugins/imagepicker/g;Ll8/k$d;Ll8/j;Lio/flutter/plugins/imagepicker/d;Lio/flutter/plugins/imagepicker/e$g;Lio/flutter/plugins/imagepicker/e$e;Lio/flutter/plugins/imagepicker/c;)V

    return-void
.end method

.method constructor <init>(Landroid/app/Activity;Ljava/io/File;Lio/flutter/plugins/imagepicker/g;Ll8/k$d;Ll8/j;Lio/flutter/plugins/imagepicker/d;Lio/flutter/plugins/imagepicker/e$g;Lio/flutter/plugins/imagepicker/e$e;Lio/flutter/plugins/imagepicker/c;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lio/flutter/plugins/imagepicker/e;->o:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugins/imagepicker/e;->p:Ljava/io/File;

    iput-object p3, p0, Lio/flutter/plugins/imagepicker/e;->q:Lio/flutter/plugins/imagepicker/g;
    ...
    iput-object p4, p0, Lio/flutter/plugins/imagepicker/e;->x:Ll8/k$d;

    iput-object p5, p0, Lio/flutter/plugins/imagepicker/e;->y:Ll8/j;

    iput-object p7, p0, Lio/flutter/plugins/imagepicker/e;->s:Lio/flutter/plugins/imagepicker/e$g;

    iput-object p8, p0, Lio/flutter/plugins/imagepicker/e;->t:Lio/flutter/plugins/imagepicker/e$e;

    iput-object p9, p0, Lio/flutter/plugins/imagepicker/e;->u:Lio/flutter/plugins/imagepicker/c;

    iput-object p6, p0, Lio/flutter/plugins/imagepicker/e;->r:Lio/flutter/plugins/imagepicker/d;
...
.method private A()V
    ...
    iget-object v1, p0, Lio/flutter/plugins/imagepicker/e;->o:Landroid/app/Activity;
...
.method private B()V
    ...
    iget-object v1, p0, Lio/flutter/plugins/imagepicker/e;->v:Lio/flutter/plugins/imagepicker/a;

    sget-object v2, Lio/flutter/plugins/imagepicker/a;->o:Lio/flutter/plugins/imagepicker/a;
    ...
    iput-object v2, p0, Lio/flutter/plugins/imagepicker/e;->w:Landroid/net/Uri;

    iget-object v2, p0, Lio/flutter/plugins/imagepicker/e;->t:Lio/flutter/plugins/imagepicker/e$e;
    ...
    :try_start_0
    iget-object v2, p0, Lio/flutter/plugins/imagepicker/e;->o:Landroid/app/Activity;
...
.method private C()V
    ...
    iget-object v1, p0, Lio/flutter/plugins/imagepicker/e;->y:Ll8/j;

    if-eqz v1, :cond_0

    const-string v2, "maxDuration"

    invoke-virtual {v1, v2}, Ll8/j;->a(Ljava/lang/String;)Ljava/lang/Object;
...
.method private D()Z
    ...
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->s:Lio/flutter/plugins/imagepicker/e$g;
...
.method private H(Ll8/j;Ll8/k$d;)Z
    .locals 1

    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->x:Ll8/k$d;
    ...
    :cond_0
    iput-object p1, p0, Lio/flutter/plugins/imagepicker/e;->y:Ll8/j;

    iput-object p2, p0, Lio/flutter/plugins/imagepicker/e;->x:Ll8/k$d;

    iget-object p1, p0, Lio/flutter/plugins/imagepicker/e;->r:Lio/flutter/plugins/imagepicker/d;
...
.method private g()V
    ...
    iput-object v0, p0, Lio/flutter/plugins/imagepicker/e;->y:Ll8/j;

    iput-object v0, p0, Lio/flutter/plugins/imagepicker/e;->x:Ll8/k$d;
...
.method private h(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_0
    iget-object v1, p0, Lio/flutter/plugins/imagepicker/e;->p:Ljava/io/File;
...
.method private k(Ll8/k$d;)V
    ...
    invoke-interface {p1, v0, v1, v2}, Ll8/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->r:Lio/flutter/plugins/imagepicker/d;
    ...
    :cond_0
    invoke-interface {v0, p1, p2, v1}, Ll8/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private o(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->y:Ll8/j;
    ...
    iget-object v2, p0, Lio/flutter/plugins/imagepicker/e;->y:Ll8/j;

    const-string v3, "imageQuality"

    invoke-virtual {v2, v3}, Ll8/j;->a(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Ljava/lang/Integer;

    iget-object v3, p0, Lio/flutter/plugins/imagepicker/e;->q:Lio/flutter/plugins/imagepicker/g;
...
.method private p(Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->o:Landroid/app/Activity;
...
.method private q(I)V
    ...
    iget-object p1, p0, Lio/flutter/plugins/imagepicker/e;->t:Lio/flutter/plugins/imagepicker/e$e;

    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->w:Landroid/net/Uri;
...
.method private s(ILandroid/content/Intent;)V
    ...
    iget-object p1, p0, Lio/flutter/plugins/imagepicker/e;->u:Lio/flutter/plugins/imagepicker/c;
    ...
    invoke-virtual {p1, v0, p2}, Lio/flutter/plugins/imagepicker/c;->d(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method private t(ILandroid/content/Intent;)V
    ...
    iget-object v2, p0, Lio/flutter/plugins/imagepicker/e;->u:Lio/flutter/plugins/imagepicker/c;

    iget-object v3, p0, Lio/flutter/plugins/imagepicker/e;->o:Landroid/app/Activity;
    ...
    invoke-virtual {v2, v3, v4}, Lio/flutter/plugins/imagepicker/c;->d(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->u:Lio/flutter/plugins/imagepicker/c;
    ...
    invoke-virtual {v0, v2, p2}, Lio/flutter/plugins/imagepicker/c;->d(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method E(Ll8/k$d;)V
    ...
    :goto_1
    iget-object v8, p0, Lio/flutter/plugins/imagepicker/e;->q:Lio/flutter/plugins/imagepicker/g;
...
.method F()V
    ...
    :cond_0
    iget-object v1, p0, Lio/flutter/plugins/imagepicker/e;->r:Lio/flutter/plugins/imagepicker/d;

    iget-object v0, v0, Ll8/j;->a:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugins/imagepicker/d;->d(Ll8/j;)V
...
.method G(Lio/flutter/plugins/imagepicker/a;)V
    ...
    iput-object p1, p0, Lio/flutter/plugins/imagepicker/e;->v:Lio/flutter/plugins/imagepicker/a;

    return-void
.end method

.method public I(Ll8/j;Ll8/k$d;)V
    .locals 1

    invoke-direct {p0, p1, p2}, Lio/flutter/plugins/imagepicker/e;->H(Ll8/j;Ll8/k$d;)Z

    move-result p1

    if-nez p1, :cond_0

    invoke-direct {p0, p2}, Lio/flutter/plugins/imagepicker/e;->k(Ll8/k$d;)V
    ...
    iget-object p1, p0, Lio/flutter/plugins/imagepicker/e;->s:Lio/flutter/plugins/imagepicker/e$g;
...
.method public J(Ll8/j;Ll8/k$d;)V
    .locals 1
...
.method public d(Ll8/j;Ll8/k$d;)V
    .locals 0
...
.method public e(Ll8/j;Ll8/k$d;)V
    .locals 0
...
.method public f(Ll8/j;Ll8/k$d;)V
    .locals 0

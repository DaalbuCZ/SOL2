...
.method private static synthetic A(Lf5/e;Lt4/j;)V
    .locals 2
    ...
    invoke-virtual {p0}, Lf5/e;->p()Ljava/lang/String;
...
.method private synthetic B(Lt4/j;)V
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/google/firebase/messaging/FirebaseMessaging;->u()Lt4/i;
...
.method private synthetic C(Ll8/k$d;Lt4/i;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p2}, Lt4/i;->k()Ljava/lang/Exception;
    ...
    invoke-interface {p1, v1, v0, p2}, Ll8/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private synthetic D(Lt4/j;)V
    ...
    invoke-direct {v3, v0, p1}, Lio/flutter/plugins/firebase/messaging/d;-><init>(Ljava/util/Map;Lt4/j;)V

    new-instance v0, Lio/flutter/plugins/firebase/messaging/c;

    invoke-direct {v0, p1}, Lio/flutter/plugins/firebase/messaging/c;-><init>(Lt4/j;)V
...
.method private static synthetic E(Ljava/util/Map;Lt4/j;I)V
    .locals 1
...
.method private static synthetic F(Lt4/j;Ljava/lang/String;)V
    .locals 1
...
.method private static synthetic G(Ljava/util/Map;Lt4/j;)V
    .locals 1
...
.method private synthetic H(Ljava/util/Map;Lt4/j;)V
    .locals 2
...
.method private static synthetic I(Ljava/util/Map;Lt4/j;)V
    .locals 2
...
.method private static synthetic J(Ljava/util/Map;Lt4/j;)V
    .locals 2
    ...
    invoke-virtual {v0, p0}, Lcom/google/firebase/messaging/FirebaseMessaging;->R(Ljava/lang/String;)Lt4/i;

    move-result-object p0

    invoke-static {p0}, Lt4/l;->a(Lt4/i;)Ljava/lang/Object;
...
.method private static synthetic K(Ljava/util/Map;Lt4/j;)V
    .locals 2
    ...
    invoke-virtual {v0, p0}, Lcom/google/firebase/messaging/FirebaseMessaging;->U(Ljava/lang/String;)Lt4/i;
...
.method private L()Lt4/i;
    ...
    invoke-direct {v2, p0, v0}, Lp8/k;-><init>(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
...
.method private M(Ljava/util/Map;)Lt4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p1, v0}, Lp8/n;-><init>(Ljava/util/Map;Lt4/j;)V
...
.method private N(Ljava/util/Map;)Lt4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, v0}, Lp8/i;-><init>(Lio/flutter/plugins/firebase/messaging/e;Ljava/util/Map;Lt4/j;)V
...
.method private O(Ljava/util/Map;)Lt4/i;
    ...
    invoke-direct {v2, p1, v0}, Lp8/o;-><init>(Ljava/util/Map;Lt4/j;)V
...
.method private P(Ljava/util/Map;)Lt4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p1, v0}, Lp8/p;-><init>(Ljava/util/Map;Lt4/j;)V
...
.method private Q(Ljava/util/Map;)Lt4/i;
    ...
    invoke-direct {v2, p1, v0}, Lp8/q;-><init>(Ljava/util/Map;Lt4/j;)V
...
.method public static synthetic a(Lt4/j;)V
    ...
    invoke-static {p0}, Lio/flutter/plugins/firebase/messaging/e;->w(Lt4/j;)V
...
.method public static synthetic b(Lt4/j;)V
    ...
    invoke-static {p0}, Lio/flutter/plugins/firebase/messaging/e;->x(Lt4/j;)V

    return-void
.end method

.method public static synthetic c(Lf5/e;Lt4/j;)V
    .locals 0

    invoke-static {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->A(Lf5/e;Lt4/j;)V

    return-void
.end method

.method public static synthetic d(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->B(Lt4/j;)V

    return-void
.end method

.method public static synthetic e(Ljava/util/Map;Lt4/j;)V
    .locals 0

    invoke-static {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->G(Ljava/util/Map;Lt4/j;)V

    return-void
.end method

.method public static synthetic f(Lio/flutter/plugins/firebase/messaging/e;Ll8/k$d;Lt4/i;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugins/firebase/messaging/e;->C(Ll8/k$d;Lt4/i;)V

    return-void
.end method

.method public static synthetic g(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->D(Lt4/j;)V

    return-void
.end method

.method public static synthetic h(Ljava/util/Map;Lt4/j;)V
    .locals 0

    invoke-static {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->I(Ljava/util/Map;Lt4/j;)V

    return-void
.end method

.method public static synthetic i(Lt4/j;Ljava/lang/String;)V
    .locals 0

    invoke-static {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->F(Lt4/j;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic j(Lio/flutter/plugins/firebase/messaging/e;Ljava/util/Map;Lt4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugins/firebase/messaging/e;->H(Ljava/util/Map;Lt4/j;)V

    return-void
.end method

.method public static synthetic k(Ljava/util/Map;Lt4/j;)V
    .locals 0

    invoke-static {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->J(Ljava/util/Map;Lt4/j;)V

    return-void
.end method

.method public static synthetic l(Ljava/util/Map;Lt4/j;I)V
    .locals 0

    invoke-static {p0, p1, p2}, Lio/flutter/plugins/firebase/messaging/e;->E(Ljava/util/Map;Lt4/j;I)V

    return-void
.end method

.method public static synthetic m(Ljava/util/Map;Lt4/j;)V
    .locals 0

    invoke-static {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->K(Ljava/util/Map;Lt4/j;)V

    return-void
.end method

.method public static synthetic n(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->y(Lt4/j;)V

    return-void
.end method

.method public static synthetic o(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->z(Lt4/j;)V
...
.method private q()Lt4/i;
    ...
    invoke-direct {v2, v0}, Lp8/f;-><init>(Lt4/j;)V
...
.method private s()Lt4/i;
    ...
    invoke-direct {v2, p0, v0}, Lp8/l;-><init>(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
...
.method private t()Lt4/i;
    ...
    invoke-direct {v2, p0, v0}, Lp8/m;-><init>(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
...
.method private u()Lt4/i;
    ...
    invoke-direct {v2, p0, v0}, Lp8/j;-><init>(Lio/flutter/plugins/firebase/messaging/e;Lt4/j;)V
...
.method private v(Ll8/c;)V
    ...
    iput-object v0, p0, Lio/flutter/plugins/firebase/messaging/e;->o:Ll8/k;
    ...
    invoke-static {v0}, Lw/a;->b(Landroid/content/Context;)Lw/a;

    move-result-object v0

    invoke-virtual {v0, p0, p1}, Lw/a;->c(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
...
.method private static synthetic w(Lt4/j;)V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/firebase/messaging/FirebaseMessaging;->o()Lt4/i;
...
.method private static synthetic x(Lt4/j;)V
    .locals 1
...
.method private synthetic y(Lt4/j;)V
    .locals 6
    ...
    invoke-virtual {p1, v2}, Lt4/j;->c(Ljava/lang/Object;)V
...
.method private synthetic z(Lt4/j;)V
    ...
    invoke-static {v1}, Landroidx/core/app/n;->f(Landroid/content/Context;)Landroidx/core/app/n;
...
.method public didReinitializeFirebaseCore()Lt4/i;
    ...
    invoke-direct {v2, v0}, Lp8/g;-><init>(Lt4/j;)V
...
.method public getPluginConstantsForFirebaseApp(Lf5/e;)Lt4/i;
    ...
    invoke-direct {v2, p1, v0}, Lp8/e;-><init>(Lf5/e;Lt4/j;)V
...
.method public onAttachedToActivity(Ld8/c;)V
    ...
    invoke-interface {p1, v0}, Ld8/c;->c(Ll8/p;)V
...
.method public onAttachedToEngine(Lc8/a$b;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->v(Ll8/c;)V
...
.method public onDetachedFromEngine(Lc8/a$b;)V
    ...
    invoke-static {p1}, Lw/a;->b(Landroid/content/Context;)Lw/a;

    move-result-object p1

    invoke-virtual {p1, p0}, Lw/a;->e(Landroid/content/BroadcastReceiver;)V
...
.method public onMethodCall(Ll8/j;Ll8/k$d;)V
    ...
    :pswitch_0
    invoke-direct {p0}, Lio/flutter/plugins/firebase/messaging/e;->u()Lt4/i;
    ...
    :cond_b
    :pswitch_1
    invoke-direct {p0}, Lio/flutter/plugins/firebase/messaging/e;->t()Lt4/i;
    ...
    invoke-direct {p0}, Lio/flutter/plugins/firebase/messaging/e;->L()Lt4/i;
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->M(Ljava/util/Map;)Lt4/i;
    ...
    invoke-static {v4}, Lt4/l;->e(Ljava/lang/Object;)Lt4/i;
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->O(Ljava/util/Map;)Lt4/i;
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->P(Ljava/util/Map;)Lt4/i;
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->Q(Ljava/util/Map;)Lt4/i;
    ...
    :pswitch_8
    invoke-direct {p0}, Lio/flutter/plugins/firebase/messaging/e;->q()Lt4/i;
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/firebase/messaging/e;->N(Ljava/util/Map;)Lt4/i;
    ...
    :pswitch_a
    invoke-direct {p0}, Lio/flutter/plugins/firebase/messaging/e;->s()Lt4/i;
    ...
    invoke-direct {v0, p0, p2}, Lp8/h;-><init>(Lio/flutter/plugins/firebase/messaging/e;Ll8/k$d;)V
...
.method public onNewIntent(Landroid/content/Intent;)Z
    ...
    :cond_5
    iget-object v1, p0, Lio/flutter/plugins/firebase/messaging/e;->o:Ll8/k;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object p2, p0, Lio/flutter/plugins/firebase/messaging/e;->o:Ll8/k;

    const-string v0, "Messaging#onTokenRefresh"

    :goto_0
    invoke-virtual {p2, v0, p1}, Ll8/k;->c(Ljava/lang/String;Ljava/lang/Object;)V

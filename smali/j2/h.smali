...
.method private E(Lv1/g;)Z
    .locals 4

    invoke-virtual {p0}, Lj2/h;->I()Z
...
.method public D(Lv1/g;)Z
    ...
    invoke-direct {p0, p1}, Lj2/h;->E(Lv1/g;)Z
    ...
    iput v2, p0, Lj2/h;->w:I

    if-nez v0, :cond_1

    iget-wide v2, p1, Lv1/g;->r:J

    iput-wide v2, p0, Lv1/g;->r:J
    ...
    invoke-virtual {p0, v1}, Lv1/a;->w(I)V
    ...
    invoke-virtual {p0, v2}, Lv1/g;->y(I)V

    iget-object v2, p0, Lv1/g;->p:Ljava/nio/ByteBuffer;

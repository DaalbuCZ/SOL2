...
.method protected b(Lp3/a0;)Z
    ...
    invoke-virtual {v0, p1}, Ls1/m1$b;->f0(I)Ls1/m1$b;
    ...
    invoke-virtual {p1, v1}, Ls1/m1$b;->H(I)Ls1/m1$b;

    move-result-object p1

    const/16 v0, 0x1f40

    invoke-virtual {p1, v0}, Ls1/m1$b;->f0(I)Ls1/m1$b;
...
.method protected c(Lp3/a0;J)Z
    ...
    invoke-virtual {p1, p3, v2, p2}, Lp3/a0;->j([BII)V
    ...
    invoke-virtual {p2, v0}, Ls1/m1$b;->I(Ljava/lang/String;)Ls1/m1$b;

    move-result-object p2

    iget v0, p1, Lu1/a$b;->b:I

    invoke-virtual {p2, v0}, Ls1/m1$b;->H(I)Ls1/m1$b;

    move-result-object p2

    iget p1, p1, Lu1/a$b;->a:I

    invoke-virtual {p2, p1}, Ls1/m1$b;->f0(I)Ls1/m1$b;
    ...
    invoke-virtual {p1, p2}, Ls1/m1$b;->T(Ljava/util/List;)Ls1/m1$b;
    ...
    invoke-interface {p2, p1}, Lx1/e0;->e(Ls1/m1;)V

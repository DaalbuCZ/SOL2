...
.field private static volatile c:Lc4/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc4/a;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lc4/a;->a:Lj$/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method public static b()Lc4/a;
    .locals 2
    ...
    sget-object v0, Lc4/a;->b:Ljava/lang/Object;
...
.method private final f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual {v2, p6, v1}, Lf4/b;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lc4/a;->g(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, Lc4/a;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Lc4/a;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    :cond_3
    iget-object p1, p0, Lc4/a;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p2, p0, Lc4/a;->a:Lj$/util/concurrent/ConcurrentHashMap;
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-direct/range {v1 .. v8}, Lc4/a;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lc4/a;->g(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lc4/a;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Lc4/a;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    invoke-static {p1, p2}, Lc4/a;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lc4/a;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z

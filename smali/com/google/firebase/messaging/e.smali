...
.method private d()Lcom/google/firebase/messaging/f0;
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/f0;->f(Ljava/lang/String;)Lcom/google/firebase/messaging/f0;
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/messaging/f0;->o(Ljava/util/concurrent/ExecutorService;)V

    :cond_0
    return-object v0
.end method

.method private e(Landroidx/core/app/k$e;Lcom/google/firebase/messaging/f0;)V
    .locals 5
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p2}, Lcom/google/firebase/messaging/f0;->j()Lt4/i;
    ...
    invoke-static {v1, v2, v3, v4}, Lt4/l;->b(Lt4/i;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/graphics/Bitmap;

    invoke-virtual {p1, v1}, Landroidx/core/app/k$e;->B(Landroid/graphics/Bitmap;)Landroidx/core/app/k$e;

    new-instance v2, Landroidx/core/app/k$b;

    invoke-direct {v2}, Landroidx/core/app/k$b;-><init>()V

    invoke-virtual {v2, v1}, Landroidx/core/app/k$b;->z(Landroid/graphics/Bitmap;)Landroidx/core/app/k$b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroidx/core/app/k$b;->y(Landroid/graphics/Bitmap;)Landroidx/core/app/k$b;

    move-result-object v1

    invoke-virtual {p1, v1}, Landroidx/core/app/k$e;->N(Landroidx/core/app/k$i;)Landroidx/core/app/k$e;
    :try_end_0
...
.method a()Z
    ...
    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/e;->e(Landroidx/core/app/k$e;Lcom/google/firebase/messaging/f0;)V

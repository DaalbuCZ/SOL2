...
.method public constructor <init>(Lj6/e;Li6/b;Ljava/util/concurrent/Executor;Ld4/e;Ljava/util/Random;Lcom/google/firebase/remoteconfig/internal/d;Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;Lcom/google/firebase/remoteconfig/internal/m;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/j;->a:Lj6/e;

    iput-object p2, p0, Lcom/google/firebase/remoteconfig/internal/j;->b:Li6/b;

    iput-object p3, p0, Lcom/google/firebase/remoteconfig/internal/j;->c:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Lcom/google/firebase/remoteconfig/internal/j;->d:Ld4/e;
...
.method public static synthetic a(Lcom/google/firebase/remoteconfig/internal/j;Lt4/i;Lt4/i;Ljava/util/Date;Lt4/i;)Lt4/i;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/firebase/remoteconfig/internal/j;->t(Lt4/i;Lt4/i;Ljava/util/Date;Lt4/i;)Lt4/i;
...
.method public static synthetic b(Lcom/google/firebase/remoteconfig/internal/j;JLt4/i;)Lt4/i;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/j;->r(JLt4/i;)Lt4/i;
...
.method public static synthetic c(Lcom/google/firebase/remoteconfig/internal/j;Ljava/util/Date;Lt4/i;)Lt4/i;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/remoteconfig/internal/j;->u(Ljava/util/Date;Lt4/i;)Lt4/i;
...
.method public static synthetic d(Lcom/google/firebase/remoteconfig/internal/j$a;Lcom/google/firebase/remoteconfig/internal/e;)Lt4/i;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/remoteconfig/internal/j;->s(Lcom/google/firebase/remoteconfig/internal/j$a;Lcom/google/firebase/remoteconfig/internal/e;)Lt4/i;
...
.method private f(Ld7/i;)Ld7/i;
    .locals 5

    invoke-virtual {p1}, Ld7/i;->a()I
    ...
    invoke-direct {p1, v0}, Ld7/e;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v0, p1}, Ld7/i;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private j(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/j$a;
    ...
    :try_end_0
    .catch Ld7/i; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p1, p2, p3}, Ld7/g;-><init>(J)V

    throw p1

    :cond_1
    invoke-direct {p0, p1}, Lcom/google/firebase/remoteconfig/internal/j;->f(Ld7/i;)Ld7/i;
...
.method private k(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lt4/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, p3}, Lcom/google/firebase/remoteconfig/internal/d;->k(Lcom/google/firebase/remoteconfig/internal/e;)Lt4/i;
    ...
    invoke-virtual {p2, p3, v0}, Lt4/i;->q(Ljava/util/concurrent/Executor;Lt4/h;)Lt4/i;
...
.method private l(Lt4/i;J)Lt4/i;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/j;->d:Ld4/e;
    ...
    invoke-direct {p2, p3, v1, v2}, Ld7/g;-><init>(Ljava/lang/String;J)V

    invoke-static {p2}, Lt4/l;->d(Ljava/lang/Exception;)Lt4/i;
    ...
    :cond_1
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/j;->a:Lj6/e;

    invoke-interface {p1}, Lj6/e;->a()Lt4/i;

    move-result-object p1

    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/j;->a:Lj6/e;

    const/4 p3, 0x0

    invoke-interface {p2, p3}, Lj6/e;->b(Z)Lt4/i;
    ...
    invoke-static {v1}, Lt4/l;->i([Lt4/i;)Lt4/i;
    ...
    invoke-direct {v2, p0, p1, p2, v0}, Lcom/google/firebase/remoteconfig/internal/h;-><init>(Lcom/google/firebase/remoteconfig/internal/j;Lt4/i;Lt4/i;Ljava/util/Date;)V

    invoke-virtual {p3, v1, v2}, Lt4/i;->j(Ljava/util/concurrent/Executor;Lt4/a;)Lt4/i;
    ...
    invoke-direct {p3, p0, v0}, Lcom/google/firebase/remoteconfig/internal/g;-><init>(Lcom/google/firebase/remoteconfig/internal/j;Ljava/util/Date;)V

    invoke-virtual {p1, p2, p3}, Lt4/i;->j(Ljava/util/concurrent/Executor;Lt4/a;)Lt4/i;
...
.method private n()Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/j;->b:Li6/b;
    ...
    invoke-interface {v0, v1}, Li5/a;->a(Z)Ljava/util/Map;
...
.method private p()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/j;->b:Li6/b;

    invoke-interface {v1}, Li6/b;->get()Ljava/lang/Object;
    ...
    invoke-interface {v1, v2}, Li5/a;->a(Z)Ljava/util/Map;
...
.method private synthetic r(JLt4/i;)Lt4/i;
    .locals 0

    invoke-direct {p0, p3, p1, p2}, Lcom/google/firebase/remoteconfig/internal/j;->l(Lt4/i;J)Lt4/i;
...
.method private static synthetic s(Lcom/google/firebase/remoteconfig/internal/j$a;Lcom/google/firebase/remoteconfig/internal/e;)Lt4/i;
    .locals 0
...
.method private synthetic t(Lt4/i;Lt4/i;Ljava/util/Date;Lt4/i;)Lt4/i;
    .locals 0
    ...
    invoke-direct {p2, p3, p1}, Ld7/e;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, p3, p2}, Ld7/e;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/j;->k(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lt4/i;
...
.method private synthetic u(Ljava/util/Date;Lt4/i;)Lt4/i;
    .locals 0

    invoke-direct {p0, p2, p1}, Lcom/google/firebase/remoteconfig/internal/j;->y(Lt4/i;Ljava/util/Date;)V
...
.method private y(Lt4/i;Ljava/util/Date;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public h()Lt4/i;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/firebase/remoteconfig/internal/j;->i(J)Lt4/i;
...
.method public i(J)Lt4/i;
    ...
    invoke-virtual {v0, v1, v2}, Lt4/i;->j(Ljava/util/concurrent/Executor;Lt4/a;)Lt4/i;

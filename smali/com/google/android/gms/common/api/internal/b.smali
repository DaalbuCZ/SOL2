...
.field private r:Lz3/s;

.field private s:Lz3/u;

.field private final t:Landroid/content/Context;

.field private final u:Lw3/e;

.field private final v:Lz3/g0;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lw3/e;)V
    .locals 5
    ...
    invoke-direct {v1, p2, p0}, Lj4/f;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/b;->C:Landroid/os/Handler;

    iput-object p3, p0, Lcom/google/android/gms/common/api/internal/b;->u:Lw3/e;

    new-instance p2, Lz3/g0;

    invoke-direct {p2, p3}, Lz3/g0;-><init>(Lw3/f;)V

    iput-object p2, p0, Lcom/google/android/gms/common/api/internal/b;->v:Lz3/g0;

    invoke-static {p1}, Ld4/i;->a(Landroid/content/Context;)Z
...
.method private static h(Ly3/b;Lw3/b;)Lcom/google/android/gms/common/api/Status;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Ly3/b;->b()Ljava/lang/String;
    ...
    invoke-direct {v0, p1, p0}, Lcom/google/android/gms/common/api/Status;-><init>(Lw3/b;Ljava/lang/String;)V

    return-object v0
.end method

.method private final i(Lx3/e;)Lcom/google/android/gms/common/api/internal/m;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lx3/e;->d()Ly3/b;
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/android/gms/common/api/internal/m;-><init>(Lcom/google/android/gms/common/api/internal/b;Lx3/e;)V
...
.method private final j()Lz3/u;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->s:Lz3/u;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->t:Landroid/content/Context;

    invoke-static {v0}, Lz3/t;->a(Landroid/content/Context;)Lz3/u;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->s:Lz3/u;
...
.method private final k()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->r:Lz3/s;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lz3/s;->k()I
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/b;->j()Lz3/u;

    move-result-object v1

    invoke-interface {v1, v0}, Lz3/u;->a(Lz3/s;)Lt4/i;

    :cond_1
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->r:Lz3/s;

    :cond_2
    return-void
.end method

.method private final l(Lt4/j;ILx3/e;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p3}, Lx3/e;->d()Ly3/b;

    move-result-object p3

    invoke-static {p0, p2, p3}, Lcom/google/android/gms/common/api/internal/q;->b(Lcom/google/android/gms/common/api/internal/b;ILy3/b;)Lcom/google/android/gms/common/api/internal/q;
    ...
    invoke-direct {v0, p3}, Ly3/m;-><init>(Landroid/os/Handler;)V

    invoke-virtual {p1, v0, p2}, Lt4/i;->b(Ljava/util/concurrent/Executor;Lt4/d;)Lt4/i;
...
.method static bridge synthetic s(Lcom/google/android/gms/common/api/internal/b;)Lw3/e;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/b;->u:Lw3/e;
...
.method static bridge synthetic u(Ly3/b;Lw3/b;)Lcom/google/android/gms/common/api/Status;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/android/gms/common/api/internal/b;->h(Ly3/b;Lw3/b;)Lcom/google/android/gms/common/api/Status;
...
.method public static x(Landroid/content/Context;)Lcom/google/android/gms/common/api/internal/b;
    ...
    invoke-static {}, Lz3/h;->c()Landroid/os/HandlerThread;
    ...
    invoke-direct {v2, p0, v1, v3}, Lcom/google/android/gms/common/api/internal/b;-><init>(Landroid/content/Context;Landroid/os/Looper;Lw3/e;)V
...
.method static bridge synthetic y(Lcom/google/android/gms/common/api/internal/b;)Lz3/g0;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/b;->v:Lz3/g0;
...
# virtual methods
.method public final D(Lx3/e;ILcom/google/android/gms/common/api/internal/c;Lt4/j;Ly3/k;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<O::",
    ...
    invoke-direct {p0, p4, v0, p1}, Lcom/google/android/gms/common/api/internal/b;->l(Lt4/j;ILx3/e;)V

    new-instance v0, Lcom/google/android/gms/common/api/internal/v;

    invoke-direct {v0, p2, p3, p4, p5}, Lcom/google/android/gms/common/api/internal/v;-><init>(ILcom/google/android/gms/common/api/internal/c;Lt4/j;Ly3/k;)V

    iget-object p2, p0, Lcom/google/android/gms/common/api/internal/b;->C:Landroid/os/Handler;

    new-instance p3, Ly3/u;
    ...
    invoke-direct {p3, v0, p4, p1}, Ly3/u;-><init>(Lcom/google/android/gms/common/api/internal/x;ILx3/e;)V
...
.method final E(Lz3/m;IJI)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/google/android/gms/common/api/internal/r;-><init>(Lz3/m;IJI)V
...
.method public final F(Lw3/b;I)V
    .locals 3

    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/common/api/internal/b;->g(Lw3/b;I)Z
...
.method final f()Z
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->v:Lz3/g0;

    iget-object v2, p0, Lcom/google/android/gms/common/api/internal/b;->t:Landroid/content/Context;

    const v3, 0xc1fa340

    invoke-virtual {v0, v2, v3}, Lz3/g0;->a(Landroid/content/Context;I)I
...
.method final g(Lw3/b;I)Z
    .locals 2

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/b;->u:Lw3/e;

    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/b;->t:Landroid/content/Context;

    invoke-virtual {v0, v1, p1, p2}, Lw3/e;->w(Landroid/content/Context;Lw3/b;I)Z
...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    new-array v2, v8, [Lz3/m;

    iget-object p1, p1, Lcom/google/android/gms/common/api/internal/r;->a:Lz3/m;
    ...
    invoke-direct {v0, v1, p1}, Lz3/s;-><init>(ILjava/util/List;)V

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/b;->j()Lz3/u;

    move-result-object p1

    invoke-interface {p1, v0}, Lz3/u;->a(Lz3/s;)Lt4/i;
    ...
    invoke-virtual {v0}, Lz3/s;->s()Ljava/util/List;
    ...
    iget-object v1, p1, Lcom/google/android/gms/common/api/internal/r;->a:Lz3/m;

    invoke-virtual {v0, v1}, Lz3/s;->v(Lz3/m;)V
    ...
    invoke-direct {v1, v2, v0}, Lz3/s;-><init>(ILjava/util/List;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/b;->r:Lz3/s;
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/n;->b(Lcom/google/android/gms/common/api/internal/n;)Ly3/b;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/api/internal/g;->a()Ly3/b;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/api/internal/g;->b()Lt4/j;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/b;->i(Lx3/e;)Lcom/google/android/gms/common/api/internal/m;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/b;->u:Lw3/e;

    invoke-virtual {p1}, Lw3/b;->k()I

    move-result v2

    invoke-virtual {v1, v2}, Lw3/e;->e(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lw3/b;->s()Ljava/lang/String;
    ...
    :cond_9
    invoke-static {v6}, Lcom/google/android/gms/common/api/internal/m;->w(Lcom/google/android/gms/common/api/internal/m;)Ly3/b;

    move-result-object v0

    invoke-static {v0, p1}, Lcom/google/android/gms/common/api/internal/b;->h(Ly3/b;Lw3/b;)Lcom/google/android/gms/common/api/Status;
    ...
    iget-object v1, p1, Ly3/u;->c:Lx3/e;

    invoke-virtual {v1}, Lx3/e;->d()Ly3/b;
    ...
    iget-object v0, p1, Ly3/u;->c:Lx3/e;

    invoke-direct {p0, v0}, Lcom/google/android/gms/common/api/internal/b;->i(Lx3/e;)Lcom/google/android/gms/common/api/internal/m;
    ...
    iget v2, p1, Ly3/u;->b:I

    if-eq v1, v2, :cond_c

    iget-object p1, p1, Ly3/u;->a:Lcom/google/android/gms/common/api/internal/x;
    ...
    invoke-virtual {p1}, Ly3/b0;->a()Ljava/util/Set;
    ...
    invoke-virtual {p1, v2, v0, v6}, Ly3/b0;->b(Ly3/b;Lw3/b;Ljava/lang/String;)V
    ...
    sget-object v4, Lw3/b;->r:Lw3/b;

    invoke-virtual {v3}, Lcom/google/android/gms/common/api/internal/m;->v()Lx3/a$f;

    move-result-object v3

    invoke-interface {v3}, Lx3/a$f;->k()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p1, v2, v4, v3}, Ly3/b0;->b(Ly3/b;Lw3/b;Ljava/lang/String;)V

    goto :goto_5

    :cond_e
    invoke-virtual {v3}, Lcom/google/android/gms/common/api/internal/m;->t()Lw3/b;

    move-result-object v4

    if-eqz v4, :cond_f

    invoke-virtual {p1, v2, v4, v6}, Ly3/b0;->b(Ly3/b;Lw3/b;Ljava/lang/String;)V

    goto :goto_5

    :cond_f
    invoke-virtual {v3, p1}, Lcom/google/android/gms/common/api/internal/m;->J(Ly3/b0;)V
...
.method final w(Ly3/b;)Lcom/google/android/gms/common/api/internal/m;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",

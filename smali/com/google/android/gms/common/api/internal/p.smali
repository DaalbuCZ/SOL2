...
# direct methods
.method public constructor <init>(Lcom/google/android/gms/common/api/internal/b;Lx3/a$f;Ly3/b;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/p;->c:Lz3/i;
    ...
    iput-object p2, p0, Lcom/google/android/gms/common/api/internal/p;->a:Lx3/a$f;

    iput-object p3, p0, Lcom/google/android/gms/common/api/internal/p;->b:Ly3/b;

    return-void
.end method

.method static bridge synthetic d(Lcom/google/android/gms/common/api/internal/p;)Lx3/a$f;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/p;->a:Lx3/a$f;

    return-object p0
.end method

.method static bridge synthetic e(Lcom/google/android/gms/common/api/internal/p;)Ly3/b;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/p;->b:Ly3/b;
...
.method private final h()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/p;->c:Lz3/i;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/p;->a:Lx3/a$f;

    iget-object v2, p0, Lcom/google/android/gms/common/api/internal/p;->d:Ljava/util/Set;

    invoke-interface {v1, v0, v2}, Lx3/a$f;->o(Lz3/i;Ljava/util/Set;)V
...
.method public final a(Lw3/b;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/android/gms/common/api/internal/o;-><init>(Lcom/google/android/gms/common/api/internal/p;Lw3/b;)V
...
.method public final b(Lw3/b;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/p;->b:Ly3/b;
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/gms/common/api/internal/m;->I(Lw3/b;)V

    :cond_0
    return-void
.end method

.method public final c(Lz3/i;Ljava/util/Set;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, p2}, Lw3/b;-><init>(I)V

    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/p;->b(Lw3/b;)V

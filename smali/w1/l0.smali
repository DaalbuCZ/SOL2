...
.method private static c(Lo3/l$a;Ljava/lang/String;[BLjava/util/Map;)[B
    ...
    :try_start_1
    invoke-static {p2}, Lp3/m0;->T0(Ljava/io/InputStream;)[B
    ...
    :try_start_2
    invoke-static {p2}, Lp3/m0;->n(Ljava/io/Closeable;)V
    :try_end_2
    ...
    invoke-virtual {v0}, Lo3/o0;->f()Ljava/util/Map;
...
.method private static d(Lo3/c0;I)Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, p0, Lo3/c0;->s:Ljava/util/Map;
...
.method public b(Ljava/util/UUID;Lw1/g0$d;)[B
    ...
    invoke-static {p2}, Lp3/m0;->D([B)Ljava/lang/String;

...
.method public constructor <init>(Lo6/e;Ln6/b;Ljava/util/concurrent/Executor;Li4/e;Ljava/util/Random;Lcom/google/firebase/remoteconfig/internal/d;Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;Lcom/google/firebase/remoteconfig/internal/m;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/j;->a:Lo6/e;

    iput-object p2, p0, Lcom/google/firebase/remoteconfig/internal/j;->b:Ln6/b;

    iput-object p3, p0, Lcom/google/firebase/remoteconfig/internal/j;->c:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Lcom/google/firebase/remoteconfig/internal/j;->d:Li4/e;
...
.method public static synthetic a(Lcom/google/firebase/remoteconfig/internal/j;Ly4/i;Ly4/i;Ljava/util/Date;Ly4/i;)Ly4/i;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/firebase/remoteconfig/internal/j;->t(Ly4/i;Ly4/i;Ljava/util/Date;Ly4/i;)Ly4/i;
...
.method public static synthetic b(Lcom/google/firebase/remoteconfig/internal/j;JLy4/i;)Ly4/i;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/j;->r(JLy4/i;)Ly4/i;
...
.method public static synthetic c(Lcom/google/firebase/remoteconfig/internal/j;Ljava/util/Date;Ly4/i;)Ly4/i;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/remoteconfig/internal/j;->u(Ljava/util/Date;Ly4/i;)Ly4/i;
...
.method public static synthetic d(Lcom/google/firebase/remoteconfig/internal/j$a;Lcom/google/firebase/remoteconfig/internal/e;)Ly4/i;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/remoteconfig/internal/j;->s(Lcom/google/firebase/remoteconfig/internal/j$a;Lcom/google/firebase/remoteconfig/internal/e;)Ly4/i;
...
.method private f(Li7/i;)Li7/i;
    .locals 5

    invoke-virtual {p1}, Li7/i;->a()I
    ...
    invoke-direct {v1, v2, v0, p1}, Li7/i;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private j(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/j$a;
    ...
    :try_end_0
    .catch Li7/i; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p1, p2, p3}, Li7/g;-><init>(J)V

    throw p1

    :cond_1
    invoke-direct {p0, p1}, Lcom/google/firebase/remoteconfig/internal/j;->f(Li7/i;)Li7/i;
...
.method private k(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Ly4/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, p3}, Lcom/google/firebase/remoteconfig/internal/d;->k(Lcom/google/firebase/remoteconfig/internal/e;)Ly4/i;
    ...
    invoke-virtual {p2, p3, v0}, Ly4/i;->q(Ljava/util/concurrent/Executor;Ly4/h;)Ly4/i;

    move-result-object p1
    :try_end_0
    .catch Li7/f; {:try_start_0 .. :try_end_0} :catch_0
...
.method private l(Ly4/i;J)Ly4/i;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/j;->d:Li4/e;
    ...
    invoke-direct {p2, p3, v1, v2}, Li7/g;-><init>(Ljava/lang/String;J)V

    invoke-static {p2}, Ly4/l;->d(Ljava/lang/Exception;)Ly4/i;
    ...
    :cond_1
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/j;->a:Lo6/e;

    invoke-interface {p1}, Lo6/e;->a()Ly4/i;

    move-result-object p1

    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/j;->a:Lo6/e;

    const/4 p3, 0x0

    invoke-interface {p2, p3}, Lo6/e;->b(Z)Ly4/i;

    move-result-object p2

    const/4 v1, 0x2

    new-array v1, v1, [Ly4/i;
    ...
    invoke-static {v1}, Ly4/l;->i([Ly4/i;)Ly4/i;
    ...
    invoke-direct {v2, p0, p1, p2, v0}, Lcom/google/firebase/remoteconfig/internal/h;-><init>(Lcom/google/firebase/remoteconfig/internal/j;Ly4/i;Ly4/i;Ljava/util/Date;)V

    invoke-virtual {p3, v1, v2}, Ly4/i;->j(Ljava/util/concurrent/Executor;Ly4/a;)Ly4/i;
    ...
    invoke-virtual {p1, p2, p3}, Ly4/i;->j(Ljava/util/concurrent/Executor;Ly4/a;)Ly4/i;
...
.method private n()Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/j;->b:Ln6/b;
    ...
    invoke-interface {v0, v1}, Ln5/a;->b(Z)Ljava/util/Map;
...
.method private p()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/j;->b:Ln6/b;
    ...
    invoke-interface {v1, v2}, Ln5/a;->b(Z)Ljava/util/Map;
...
.method private synthetic r(JLy4/i;)Ly4/i;
    .locals 0

    invoke-direct {p0, p3, p1, p2}, Lcom/google/firebase/remoteconfig/internal/j;->l(Ly4/i;J)Ly4/i;
...
.method private static synthetic s(Lcom/google/firebase/remoteconfig/internal/j$a;Lcom/google/firebase/remoteconfig/internal/e;)Ly4/i;
    .locals 0
...
.method private synthetic t(Ly4/i;Ly4/i;Ljava/util/Date;Ly4/i;)Ly4/i;
    .locals 0
    ...
    invoke-direct {p2, p3, p1}, Li7/e;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, p3, p2}, Li7/e;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/j;->k(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Ly4/i;
...
.method private synthetic u(Ljava/util/Date;Ly4/i;)Ly4/i;
    .locals 0

    invoke-direct {p0, p2, p1}, Lcom/google/firebase/remoteconfig/internal/j;->y(Ly4/i;Ljava/util/Date;)V
...
.method private y(Ly4/i;Ljava/util/Date;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public h()Ly4/i;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/firebase/remoteconfig/internal/j;->i(J)Ly4/i;
...
.method public i(J)Ly4/i;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/d;->e()Ly4/i;

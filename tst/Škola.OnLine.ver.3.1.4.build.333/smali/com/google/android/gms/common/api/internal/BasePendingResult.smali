...
.method private final e()Lc4/j;
    ...
    invoke-static {v1, v3}, Le4/o;->m(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lc4/j;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lc4/j;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lc4/k;
...
.method private final f(Lc4/j;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lc4/j;

    invoke-interface {p1}, Lc4/j;->d()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->m:Le4/j;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lc4/k;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lc4/k;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lc4/j;

    instance-of v0, v0, Lc4/h;

    if-eqz v0, :cond_2

    new-instance v0, Lcom/google/android/gms/common/api/internal/d0;

    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/d0;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Ld4/c0;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e()Lc4/j;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Lc4/k;Lc4/j;)V
    ...
    invoke-interface {v2, v3}, Lc4/g$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method static bridge synthetic g(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lc4/j;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lc4/j;

    return-object p0
.end method

.method public static h(Lc4/j;)V
    .locals 2
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Lc4/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final b(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Lc4/j;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d(Lc4/j;)V
...
.method public final d(Lc4/j;)V
    ...
    invoke-static {v1, v2}, Le4/o;->m(ZLjava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f(Lc4/j;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h(Lc4/j;)V

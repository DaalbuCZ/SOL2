...
.method constructor <init>(Ls8/i;)V
    ...
    iput-object p1, p0, Ls8/i$a;->n:Ls8/i;
...
.method public onMethodCall(Lt8/j;Lt8/k$d;)V
    ...
    iget-object v1, p0, Ls8/i$a;->n:Ls8/i;

    invoke-static {v1}, Ls8/i;->a(Ls8/i;)Ls8/i$h;
    ...
    :pswitch_0
    iget-object p1, p0, Ls8/i$a;->n:Ls8/i;

    invoke-static {p1}, Ls8/i;->a(Ls8/i;)Ls8/i$h;

    move-result-object p1

    invoke-interface {p1}, Ls8/i$h;->l()Z
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->g(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-static {p1}, Ls8/i$e;->e(Ljava/lang/String;)Ls8/i$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lt8/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Ls8/i$a;->n:Ls8/i;

    invoke-static {v2}, Ls8/i;->a(Ls8/i;)Ls8/i$h;

    move-result-object v2

    invoke-interface {v2, p1}, Ls8/i$h;->m(Ls8/i$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p1}, Ls8/i$h;->c()V
    :try_end_3
    ...
    invoke-static {v1, p1}, Ls8/i;->f(Ls8/i;Lorg/json/JSONObject;)Ls8/i$j;
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->h(Ls8/i$j;)V
    ...
    invoke-interface {p1}, Ls8/i$h;->f()V
    ...
    invoke-interface {p1}, Ls8/i$h;->e()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Ls8/i;->e(Ls8/i;Ljava/lang/String;)Ls8/i$k;
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->a(Ls8/i$k;)V
    ...
    invoke-static {v1, p1}, Ls8/i;->d(Ls8/i;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->d(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Ls8/i;->c(Ls8/i;Lorg/json/JSONObject;)Ls8/i$c;
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->k(Ls8/i$c;)V
    ...
    invoke-static {v1, p1}, Ls8/i;->b(Ls8/i;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->i(I)V
    ...
    invoke-static {p1}, Ls8/i$g;->e(Ljava/lang/String;)Ls8/i$g;
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->j(Ls8/i$g;)V
    ...
    invoke-static {p1}, Ls8/i$i;->e(Ljava/lang/String;)Ls8/i$i;
    ...
    invoke-interface {v1, p1}, Ls8/i$h;->b(Ls8/i$i;)V

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/q;->v:Ls8/k$g;
...
.method private M()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/q;->v:Ls8/k$g;

    invoke-interface {v1, v0}, Ls8/k$g;->h(I)V
...
.method private N(Z)V
    ...
    invoke-virtual {v4}, Lio/flutter/embedding/android/g;->f()V
...
.method private synthetic S(ILandroid/view/View;Z)V
    ...
    iget-object p2, p0, Lio/flutter/plugin/platform/q;->g:Ls8/k;
...
.method static synthetic p(Lio/flutter/plugin/platform/q;)Ls8/k;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/q;->g:Ls8/k;
...
# virtual methods
.method public B(Landroid/content/Context;Lio/flutter/view/d;Lg8/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Ls8/k;-><init>(Lg8/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/q;->g:Ls8/k;

    iget-object p2, p0, Lio/flutter/plugin/platform/q;->v:Ls8/k$g;

    invoke-virtual {p1, p2}, Ls8/k;->e(Ls8/k$g;)V
...
.method public D(Lr8/a;)V
    ...
    invoke-direct {v0, p1, v1}, Lio/flutter/embedding/android/a;-><init>(Lr8/a;Z)V
...
.method public E(Lio/flutter/embedding/android/k;)V
    ...
    invoke-interface {v0, v1}, Lio/flutter/plugin/platform/f;->g(Landroid/view/View;)V
...
.method public J()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/q;->g:Ls8/k;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Ls8/k;->e(Ls8/k$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/q;->I()V

    iput-object v1, p0, Lio/flutter/plugin/platform/q;->g:Ls8/k;
...
.method Q(I)V
    ...
    invoke-direct {v1, v2, v3, v4}, Lj8/a;-><init>(Landroid/content/Context;FLio/flutter/embedding/android/a;)V
    ...
    invoke-virtual {v1, v2}, Lj8/a;->setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
...
.method public Z(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lj8/a;->a(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
...
.method public k0(FLs8/k$f;Z)Landroid/view/MotionEvent;
    .locals 20

    move-object/from16 v0, p2

    iget-wide v1, v0, Ls8/k$f;->p:J
    ...
    iget-object v3, v0, Ls8/k$f;->g:Ljava/lang/Object;
    ...
    iget v8, v0, Ls8/k$f;->d:I

    iget v9, v0, Ls8/k$f;->e:I
    ...
    :cond_0
    iget-object v1, v0, Ls8/k$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v1, v0, Ls8/k$f;->c:Ljava/lang/Number;
    ...
    iget v12, v0, Ls8/k$f;->h:I

    iget v13, v0, Ls8/k$f;->i:I

    iget v14, v0, Ls8/k$f;->j:F

    iget v15, v0, Ls8/k$f;->k:F

    iget v1, v0, Ls8/k$f;->l:I

    iget v3, v0, Ls8/k$f;->m:I

    iget v2, v0, Ls8/k$f;->n:I

    iget v0, v0, Ls8/k$f;->o:I

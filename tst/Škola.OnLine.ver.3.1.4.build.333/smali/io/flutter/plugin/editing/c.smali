...
# direct methods
.method public constructor <init>(Ls8/p$e;Landroid/view/View;)V
    .locals 2
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/c;->y:Landroid/view/inputmethod/BaseInputConnection;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/editing/c;->n(Ls8/p$e;)V
...
.method public b()V
    ...
    invoke-static {v0, v2}, Lf8/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public n(Ls8/p$e;)V
    ...
    iget-object v1, p1, Ls8/p$e;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Ls8/p$e;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    iget v0, p1, Ls8/p$e;->b:I

    iget v1, p1, Ls8/p$e;->c:I
    ...
    :goto_0
    iget v0, p1, Ls8/p$e;->d:I

    iget p1, p1, Ls8/p$e;->e:I

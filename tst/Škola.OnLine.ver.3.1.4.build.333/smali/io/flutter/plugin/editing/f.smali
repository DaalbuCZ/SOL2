...
.field private final d:Ls8/p;

.field private e:Lio/flutter/plugin/editing/f$c;

.field private f:Ls8/p$b;
...
.field private n:Ls8/p$e;

.field private o:Z


# direct methods
.method public constructor <init>(Landroid/view/View;Ls8/p;Lio/flutter/plugin/platform/q;)V
    .locals 4
    ...
    invoke-direct {v0, v1, p1}, Lio/flutter/plugin/editing/c;-><init>(Ls8/p$e;Landroid/view/View;)V
    ...
    :cond_3
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->d:Ls8/p;
    ...
    invoke-virtual {p2, p1}, Ls8/p;->n(Ls8/p$f;)V

    invoke-virtual {p2}, Ls8/p;->k()V
...
.method private A(DD[D)V
    ...
    new-instance v14, Lio/flutter/plugin/editing/f$b;

    invoke-direct {v14, v0, v8, v5, v6}, Lio/flutter/plugin/editing/f$b;-><init>(Lio/flutter/plugin/editing/f;Z[D[D)V

    invoke-interface {v14, v1, v2, v10, v11}, Lio/flutter/plugin/editing/f$d;->a(DD)V

    invoke-interface {v14, v1, v2, v3, v4}, Lio/flutter/plugin/editing/f$d;->a(DD)V

    invoke-interface {v14, v10, v11, v3, v4}, Lio/flutter/plugin/editing/f$d;->a(DD)V
...
.method private H(Ls8/p$b;)V
    ...
    iget-object v0, p1, Ls8/p$b;->j:Ls8/p$b$a;
    ...
    :cond_1
    iget-object v0, p1, Ls8/p$b;->l:[Ls8/p$b;
    ...
    iget-object v0, v0, Ls8/p$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v2, Ls8/p$b;->j:Ls8/p$b$a;

    if-eqz v3, :cond_3

    iget-object v4, p0, Lio/flutter/plugin/editing/f;->g:Landroid/util/SparseArray;

    iget-object v5, v3, Ls8/p$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v3, Ls8/p$b$a;->c:Ls8/p$e;

    iget-object v3, v3, Ls8/p$e;->a:Ljava/lang/String;
...
.method private k()Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->f:Ls8/p$b;

    const/4 v1, 0x1

    if-eqz v0, :cond_2

    iget-object v0, v0, Ls8/p$b;->g:Ls8/p$c;
    ...
    :cond_0
    iget-object v0, v0, Ls8/p$c;->a:Ls8/p$g;

    sget-object v2, Ls8/p$g;->y:Ls8/p$g;
...
.method private static n(Ls8/p$e;Ls8/p$e;)Z
    .locals 7

    iget v0, p0, Ls8/p$e;->e:I

    iget v1, p0, Ls8/p$e;->d:I

    sub-int/2addr v0, v1

    iget v1, p1, Ls8/p$e;->e:I

    iget v2, p1, Ls8/p$e;->d:I
    ...
    iget-object v4, p0, Ls8/p$e;->a:Ljava/lang/String;

    iget v5, p0, Ls8/p$e;->d:I
    ...
    iget-object v5, p1, Ls8/p$e;->a:Ljava/lang/String;

    iget v6, p1, Ls8/p$e;->d:I
...
.method private static t(Ls8/p$c;ZZZZLs8/p$d;)I
    .locals 1

    iget-object p4, p0, Ls8/p$c;->a:Ls8/p$g;

    sget-object v0, Ls8/p$g;->p:Ls8/p$g;
    ...
    :cond_0
    sget-object v0, Ls8/p$g;->s:Ls8/p$g;

    if-ne p4, v0, :cond_3

    const/4 p1, 0x2

    iget-boolean p2, p0, Ls8/p$c;->b:Z
    ...
    :cond_1
    iget-boolean p0, p0, Ls8/p$c;->c:Z
    ...
    :cond_3
    sget-object p0, Ls8/p$g;->t:Ls8/p$g;
    ...
    :cond_4
    sget-object p0, Ls8/p$g;->y:Ls8/p$g;
    ...
    sget-object v0, Ls8/p$g;->u:Ls8/p$g;
    ...
    :cond_6
    sget-object v0, Ls8/p$g;->v:Ls8/p$g;
    ...
    :cond_7
    sget-object v0, Ls8/p$g;->w:Ls8/p$g;
    ...
    :cond_8
    sget-object v0, Ls8/p$g;->x:Ls8/p$g;
    ...
    :cond_9
    sget-object v0, Ls8/p$g;->q:Ls8/p$g;
    ...
    :cond_a
    sget-object v0, Ls8/p$g;->r:Ls8/p$g;
    ...
    :cond_e
    :goto_1
    sget-object p1, Ls8/p$d;->o:Ls8/p$d;
    ...
    :cond_f
    sget-object p1, Ls8/p$d;->p:Ls8/p$d;
    ...
    :cond_10
    sget-object p1, Ls8/p$d;->q:Ls8/p$d;
...
.method private w(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Ls8/p$b;->j:Ls8/p$b$a;
...
.method D(ILs8/p$b;)V
    ...
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->f:Ls8/p$b;
    ...
    iget-object v0, p2, Ls8/p$b;->j:Ls8/p$b$a;

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    iget-object v0, v0, Ls8/p$b$a;->c:Ls8/p$e;
    ...
    invoke-direct {p1, v0, v2}, Lio/flutter/plugin/editing/c;-><init>(Ls8/p$e;Landroid/view/View;)V

    iput-object p1, p0, Lio/flutter/plugin/editing/f;->h:Lio/flutter/plugin/editing/c;

    invoke-direct {p0, p2}, Lio/flutter/plugin/editing/f;->H(Ls8/p$b;)V
...
.method E(Landroid/view/View;Ls8/p$e;)V
    .locals 2
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->n:Ls8/p$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ls8/p$e;->b()Z
    ...
    invoke-static {v0, p2}, Lio/flutter/plugin/editing/f;->n(Ls8/p$e;Ls8/p$e;)Z
    ...
    invoke-static {v0, v1}, Lf8/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->n:Ls8/p$e;

    iget-object v0, p0, Lio/flutter/plugin/editing/f;->h:Lio/flutter/plugin/editing/c;

    invoke-virtual {v0, p2}, Lio/flutter/plugin/editing/c;->n(Ls8/p$e;)V
...
.method public a(ZZZ)V
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/f;->n:Ls8/p$e;
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/f;->n:Ls8/p$e;

    iget-object v2, v2, Ls8/p$e;->a:Ljava/lang/String;
    ...
    iget v2, v1, Ls8/p$e;->b:I

    if-ne p1, v2, :cond_1

    iget v2, v1, Ls8/p$e;->c:I

    if-ne p2, v2, :cond_1

    iget v2, v1, Ls8/p$e;->d:I

    if-ne p3, v2, :cond_1

    iget v1, v1, Ls8/p$e;->e:I
    ...
    invoke-static {v2, v1}, Lf8/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lio/flutter/plugin/editing/f;->f:Ls8/p$b;

    iget-boolean v1, v1, Ls8/p$b;->e:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, Lio/flutter/plugin/editing/f;->d:Ls8/p;
    ...
    invoke-virtual {v1, v2, v0}, Ls8/p;->q(ILjava/util/ArrayList;)V
    ...
    :cond_3
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->d:Ls8/p;
    ...
    invoke-virtual/range {v0 .. v6}, Ls8/p;->p(ILjava/lang/String;IIII)V

    :goto_2
    new-instance v6, Ls8/p$e;
    ...
    invoke-direct/range {v0 .. v5}, Ls8/p$e;-><init>(Ljava/lang/String;IIII)V

    iput-object v6, p0, Lio/flutter/plugin/editing/f;->n:Ls8/p$e;
...
.method public j(Landroid/util/SparseArray;)V
    ...
    check-cast v3, Ls8/p$b;

    if-eqz v3, :cond_4

    iget-object v3, v3, Ls8/p$b;->j:Ls8/p$b$a;
    ...
    invoke-direct/range {v5 .. v10}, Ls8/p$e;-><init>(Ljava/lang/String;IIII)V

    iget-object v5, v3, Ls8/p$b$a;->a:Ljava/lang/String;

    iget-object v6, v0, Ls8/p$b$a;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lio/flutter/plugin/editing/c;->n(Ls8/p$e;)V

    goto :goto_1

    :cond_3
    iget-object v3, v3, Ls8/p$b$a;->a:Ljava/lang/String;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/plugin/editing/f;->d:Ls8/p;

    iget-object v0, p0, Lio/flutter/plugin/editing/f;->e:Lio/flutter/plugin/editing/f$c;

    iget v0, v0, Lio/flutter/plugin/editing/f$c;->b:I

    invoke-virtual {p1, v0, v1}, Ls8/p;->r(ILjava/util/HashMap;)V
...
.method public l(I)V
    ...
    sget-object v2, Lio/flutter/plugin/editing/f$c$a;->p:Lio/flutter/plugin/editing/f$c$a;
...
.method m()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/f;->f:Ls8/p$b;

    invoke-direct {p0, v0}, Lio/flutter/plugin/editing/f;->H(Ls8/p$b;)V
...
.method public o(Landroid/view/View;Lio/flutter/embedding/android/s;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v1, v0, Ls8/p$b;->g:Ls8/p$c;

    iget-boolean v2, v0, Ls8/p$b;->a:Z

    iget-boolean v3, v0, Ls8/p$b;->b:Z

    iget-boolean v4, v0, Ls8/p$b;->c:Z

    iget-boolean v5, v0, Ls8/p$b;->d:Z

    iget-object v6, v0, Ls8/p$b;->f:Ls8/p$d;

    invoke-static/range {v1 .. v6}, Lio/flutter/plugin/editing/f;->t(Ls8/p$c;ZZZZLs8/p$d;)I
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/f;->f:Ls8/p$b;

    iget-boolean v2, v2, Ls8/p$b;->d:Z
    ...
    iget-object v1, v1, Ls8/p$b;->h:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Ls8/p$b;->i:Ljava/lang/String;
    ...
    iget-object v0, v1, Ls8/p$b;->k:[Ljava/lang/String;

    if-eqz v0, :cond_8

    invoke-static {p3, v0}, Ls/a;->a(Landroid/view/inputmethod/EditorInfo;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lio/flutter/plugin/editing/f;->d:Ls8/p;
    ...
    invoke-direct/range {v1 .. v7}, Lio/flutter/plugin/editing/b;-><init>(Landroid/view/View;ILs8/p;Lio/flutter/plugin/editing/b$a;Lio/flutter/plugin/editing/c;Landroid/view/inputmethod/EditorInfo;)V
...
.method public p()V
    ...
    invoke-virtual {v0, v1}, Ls8/p;->n(Ls8/p$f;)V
...
.method public z(Landroid/view/ViewStructure;I)V
    ...
    :cond_0
    iget-object v2, v0, Lio/flutter/plugin/editing/f;->f:Ls8/p$b;

    iget-object v2, v2, Ls8/p$b;->j:Ls8/p$b$a;

    iget-object v2, v2, Ls8/p$b$a;->a:Ljava/lang/String;
    ...
    check-cast v7, Ls8/p$b;

    iget-object v7, v7, Ls8/p$b;->j:Ls8/p$b$a;
    ...
    iget-object v9, v7, Ls8/p$b$a;->b:[Ljava/lang/String;
    ...
    iget-object v8, v7, Ls8/p$b$a;->d:Ljava/lang/String;
    ...
    iget-object v6, v7, Ls8/p$b$a;->c:Ls8/p$e;

    iget-object v6, v6, Ls8/p$e;->a:Ljava/lang/String;

...
.field private r:Lr8/a;

.field private final s:Landroid/view/SurfaceHolder$Callback;

.field private final t:Lr8/b;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Z)V
    ...
    iput-boolean p1, p0, Lio/flutter/embedding/android/h;->o:Z
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/h;->s:Landroid/view/SurfaceHolder$Callback;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/h;->t:Lr8/b;

    iput-boolean p3, p0, Lio/flutter/embedding/android/h;->n:Z
...
.method static synthetic b(Lio/flutter/embedding/android/h;)Z
    ...
    iget-boolean p0, p0, Lio/flutter/embedding/android/h;->q:Z
...
.method static synthetic d(Lio/flutter/embedding/android/h;II)V
    .locals 0
...
.method static synthetic i(Lio/flutter/embedding/android/h;)Lr8/a;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/android/h;->r:Lr8/a;
...
.method private j(II)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/h;->r:Lr8/a;
    ...
    invoke-virtual {v0, p1, p2}, Lr8/a;->w(II)V
...
.method private k()V
    ...
    iget-boolean v2, p0, Lio/flutter/embedding/android/h;->p:Z

    invoke-virtual {v0, v1, v2}, Lr8/a;->u(Landroid/view/Surface;Z)V
...
.method private m()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->s:Landroid/view/SurfaceHolder$Callback;
...
.method public e()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/h;->r:Lr8/a;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lio/flutter/embedding/android/h;->p:Z
...
.method public f()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->t:Lr8/b;

    invoke-virtual {v0, v1}, Lr8/a;->q(Lr8/b;)V
...
.method public g(Lr8/a;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->r:Lr8/a;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/h;->t:Lr8/b;

    invoke-virtual {v1, v2}, Lr8/a;->q(Lr8/b;)V

    :cond_0
    iput-object p1, p0, Lio/flutter/embedding/android/h;->r:Lr8/a;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lio/flutter/embedding/android/h;->q:Z

    iget-object v1, p0, Lio/flutter/embedding/android/h;->t:Lr8/b;

    invoke-virtual {p1, v1}, Lr8/a;->g(Lr8/b;)V

    iget-boolean p1, p0, Lio/flutter/embedding/android/h;->o:Z

...
.method private c(Lt8/c;Lio/flutter/plugin/platform/h;Landroid/content/Context;Landroid/view/View;Lio/flutter/plugins/webviewflutter/h;)V
    .locals 3
    ...
    invoke-direct {v1, p1, v2}, Lio/flutter/plugins/webviewflutter/n2;-><init>(Lt8/c;Lio/flutter/plugins/webviewflutter/i2;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/f2;->d0(Lt8/c;Lio/flutter/plugins/webviewflutter/k$c0;)V

    iget-object p2, p0, Lio/flutter/plugins/webviewflutter/o3;->q:Lio/flutter/plugins/webviewflutter/o2;

    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/y;->d(Lt8/c;Lio/flutter/plugins/webviewflutter/k$l;)V
    ...
    invoke-direct {v0, p1, v1}, Lio/flutter/plugins/webviewflutter/x2;-><init>(Lt8/c;Lio/flutter/plugins/webviewflutter/i2;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/d1;->d(Lt8/c;Lio/flutter/plugins/webviewflutter/k$a0;)V
    ...
    invoke-direct {v0, p1, v1}, Lio/flutter/plugins/webviewflutter/r2;-><init>(Lt8/c;Lio/flutter/plugins/webviewflutter/i2;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/c0;->d(Lt8/c;Lio/flutter/plugins/webviewflutter/k$q;)V
    ...
    invoke-direct {v0, p1, v1}, Lio/flutter/plugins/webviewflutter/d;-><init>(Lt8/c;Lio/flutter/plugins/webviewflutter/i2;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/r;->d(Lt8/c;Lio/flutter/plugins/webviewflutter/k$f;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/r0;->D(Lt8/c;Lio/flutter/plugins/webviewflutter/k$u;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/u;->f(Lt8/c;Lio/flutter/plugins/webviewflutter/k$h;)V

    new-instance p2, Lio/flutter/plugins/webviewflutter/b;

    invoke-direct {p2}, Lio/flutter/plugins/webviewflutter/b;-><init>()V

    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/n;->f(Lt8/c;Lio/flutter/plugins/webviewflutter/k$b;)V
    ...
    invoke-static {p1, p2}, Lio/flutter/plugins/webviewflutter/u0;->f(Lt8/c;Lio/flutter/plugins/webviewflutter/k$w;)V
...
.method public onAttachedToEngine(Lk8/a$b;)V
    ...
    iput-object p1, p0, Lio/flutter/plugins/webviewflutter/o3;->o:Lk8/a$b;

    invoke-virtual {p1}, Lk8/a$b;->b()Lt8/c;

    move-result-object v1

    invoke-virtual {p1}, Lk8/a$b;->d()Lio/flutter/plugin/platform/h;
    ...
    invoke-virtual {p1}, Lk8/a$b;->c()Lk8/a$a;

    move-result-object p1

    invoke-direct {v5, v0, p1}, Lio/flutter/plugins/webviewflutter/h$a;-><init>(Landroid/content/res/AssetManager;Lk8/a$a;)V

    const/4 v4, 0x0

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, Lio/flutter/plugins/webviewflutter/o3;->c(Lt8/c;Lio/flutter/plugin/platform/h;Landroid/content/Context;Landroid/view/View;Lio/flutter/plugins/webviewflutter/h;)V
...
.method public onDetachedFromActivity()V
    ...
    iget-object v0, p0, Lio/flutter/plugins/webviewflutter/o3;->o:Lk8/a$b;

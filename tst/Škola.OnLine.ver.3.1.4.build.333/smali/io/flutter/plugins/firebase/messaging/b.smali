...
.method public static synthetic a(Lio/flutter/plugins/firebase/messaging/b;Li8/f;Landroid/os/Handler;Lio/flutter/embedding/engine/e;J)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lio/flutter/plugins/firebase/messaging/b;->k(Li8/f;Landroid/os/Handler;Lio/flutter/embedding/engine/e;J)V

    return-void
.end method

.method public static synthetic b(Lio/flutter/plugins/firebase/messaging/b;Li8/f;Lio/flutter/embedding/engine/e;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lio/flutter/plugins/firebase/messaging/b;->j(Li8/f;Lio/flutter/embedding/engine/e;J)V
...
.method private g(Lt8/c;)V
    ...
    iput-object v0, p0, Lio/flutter/plugins/firebase/messaging/b;->o:Lt8/k;
...
.method private synthetic j(Li8/f;Lio/flutter/embedding/engine/e;J)V
    .locals 4

    invoke-virtual {p1}, Li8/f;->i()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lio/flutter/embedding/engine/a;->h()Lg8/a;

    move-result-object p3

    invoke-direct {p0, p3}, Lio/flutter/plugins/firebase/messaging/b;->g(Lt8/c;)V

    new-instance p4, Lg8/a$b;

    invoke-direct {p4, v0, p1, p2}, Lg8/a$b;-><init>(Landroid/content/res/AssetManager;Ljava/lang/String;Lio/flutter/view/FlutterCallbackInformation;)V

    invoke-virtual {p3, p4}, Lg8/a;->j(Lg8/a$b;)V

    :cond_1
    return-void
.end method

.method private synthetic k(Li8/f;Landroid/os/Handler;Lio/flutter/embedding/engine/e;J)V
    .locals 8
    ...
    invoke-virtual {p1, v0}, Li8/f;->q(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v6}, Lx8/c;-><init>(Lio/flutter/plugins/firebase/messaging/b;Li8/f;Lio/flutter/embedding/engine/e;J)V

    const/4 p3, 0x0

    invoke-virtual {p1, v0, p3, p2, v7}, Li8/f;->h(Landroid/content/Context;[Ljava/lang/String;Landroid/os/Handler;Ljava/lang/Runnable;)V
...
.method public d(Landroid/content/Intent;Ljava/util/concurrent/CountDownLatch;)V
    ...
    iget-object p2, p0, Lio/flutter/plugins/firebase/messaging/b;->o:Lt8/k;
    ...
    invoke-virtual {p2, p1, v1, v0}, Lt8/k;->d(Ljava/lang/String;Ljava/lang/Object;Lt8/k$d;)V
...
.method public p(JLio/flutter/embedding/engine/e;)V
    ...
    invoke-direct/range {v0 .. v6}, Lx8/b;-><init>(Lio/flutter/plugins/firebase/messaging/b;Li8/f;Landroid/os/Handler;Lio/flutter/embedding/engine/e;J)V

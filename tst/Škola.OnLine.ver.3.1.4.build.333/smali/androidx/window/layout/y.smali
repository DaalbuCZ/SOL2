...
# static fields
.field public static final a:Landroidx/window/layout/y;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroidx/window/layout/y;-><init>()V

    sput-object v0, Landroidx/window/layout/y;->a:Landroidx/window/layout/y;
    ...
    sput-object v0, Landroidx/window/layout/y;->b:Ljava/lang/String;
...
.method private final f(Landroid/view/Display;)Landroid/view/DisplayCutout;
    ...
    :goto_0
    sget-object v0, Landroidx/window/layout/y;->b:Ljava/lang/String;
...
# virtual methods
.method public a(Landroid/app/Activity;)Landroidx/window/layout/w;
    .locals 2
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/y;->e(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/y;->d(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/y;->c(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :cond_3
    invoke-virtual {p0, p1}, Landroidx/window/layout/y;->b(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-direct {v0, p1}, Landroidx/window/layout/w;-><init>(Landroid/graphics/Rect;)V
...
.method public final b(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Landroidx/window/layout/y;->h(Landroid/view/Display;)Landroid/graphics/Point;
...
.method public final c(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v1}, Landroidx/window/layout/y;->h(Landroid/view/Display;)Landroid/graphics/Point;

    move-result-object v1

    invoke-direct {p0, p1}, Landroidx/window/layout/y;->g(Landroid/content/Context;)I
...
.method public final d(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :goto_1
    sget-object v3, Landroidx/window/layout/y;->b:Ljava/lang/String;

    invoke-static {v3, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/Throwable;)I

    invoke-direct {p0, p1, v0}, Landroidx/window/layout/y;->i(Landroid/app/Activity;Landroid/graphics/Rect;)V
    ...
    invoke-static {v1, v5}, Ls9/k;->d(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, Landroidx/window/layout/y;->f(Landroid/view/Display;)Landroid/view/DisplayCutout;
...
.method public final e(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :goto_0
    sget-object v1, Landroidx/window/layout/y;->b:Ljava/lang/String;

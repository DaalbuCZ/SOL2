...
# instance fields
.field private o:Landroidx/vectordrawable/graphics/drawable/h$h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/vectordrawable/graphics/drawable/h;->x:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->s:Z

    const/16 v0, 0x9

    new-array v0, v0, [F

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->u:[F

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->v:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->w:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->o:Landroidx/vectordrawable/graphics/drawable/h$h;
...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/h$h;)V
    ...
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->o:Landroidx/vectordrawable/graphics/drawable/h$h;

    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->p:Landroid/graphics/PorterDuffColorFilter;
    ...
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->p:Landroid/graphics/PorterDuffColorFilter;
...
.method public static b(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroidx/vectordrawable/graphics/drawable/h;
    ...
    iput-object p0, v0, Landroidx/vectordrawable/graphics/drawable/g;->n:Landroid/graphics/drawable/Drawable;

    new-instance p0, Landroidx/vectordrawable/graphics/drawable/h$i;

    iget-object p1, v0, Landroidx/vectordrawable/graphics/drawable/g;->n:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p0, v0, Landroidx/vectordrawable/graphics/drawable/h;->t:Landroid/graphics/drawable/Drawable$ConstantState;
...
.method private e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->o:Landroidx/vectordrawable/graphics/drawable/h$h;
    ...
    invoke-virtual {v6, v7, v3}, Lo/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v7, v8, v3}, Lo/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {p2, p1, v1}, Lo/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public canApplyTheme()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g;->n:Landroid/graphics/drawable/Drawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->w:Landroid/graphics/Rect;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->q:Landroid/graphics/ColorFilter;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->v:Landroid/graphics/Matrix;

    invoke-virtual {p1, v1}, Landroid/graphics/Canvas;->getMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->v:Landroid/graphics/Matrix;

    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->u:[F

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->u:[F
    ...
    iget-object v3, p0, Landroidx/vectordrawable/graphics/drawable/h;->u:[F
    ...
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/h;->u:[F
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/h;->u:[F
    ...
    :cond_4
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/h;->w:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/h;->w:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->o:Landroidx/vectordrawable/graphics/drawable/h$h;

    invoke-virtual {v2, v1, v3}, Landroidx/vectordrawable/graphics/drawable/h$h;->c(II)V

    iget-boolean v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->s:Z
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->o:Landroidx/vectordrawable/graphics/drawable/h$h;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->w:Landroid/graphics/Rect;
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/g;->n:Landroid/graphics/drawable/Drawable;
...
.method h(Z)V
    ...
    iput-boolean p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->s:Z
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->p:Landroid/graphics/PorterDuffColorFilter;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->r:Z
    ...
    iput-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->r:Z
...
.method protected onStateChange([I)Z
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->p:Landroid/graphics/PorterDuffColorFilter;
...
.method public setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->q:Landroid/graphics/ColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->p:Landroid/graphics/PorterDuffColorFilter;

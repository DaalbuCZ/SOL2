...
.method public constructor <init>(I)V
    ...
    iput-object p1, p0, Lm2/h;->c:Lu3/a0;
    ...
    iput-object p1, p0, Lm2/h;->d:Lu3/a0;
    ...
    iput-object v0, p0, Lm2/h;->e:Lu3/z;
...
.method private e(Lc2/m;)V
    ...
    invoke-direct {p0, p1}, Lm2/h;->l(Lc2/m;)I
    ...
    :try_start_0
    iget-object v6, p0, Lm2/h;->d:Lu3/a0;
    ...
    invoke-interface {p1, v6, v1, v7, v5}, Lc2/m;->m([BIIZ)Z
    ...
    invoke-virtual {v6, v1}, Lu3/a0;->R(I)V

    iget-object v6, p0, Lm2/h;->d:Lu3/a0;

    invoke-virtual {v6}, Lu3/a0;->K()I
    ...
    :cond_4
    iget-object v6, p0, Lm2/h;->e:Lu3/z;

    const/16 v7, 0xe

    invoke-virtual {v6, v7}, Lu3/z;->p(I)V

    iget-object v6, p0, Lm2/h;->e:Lu3/z;

    const/16 v7, 0xd

    invoke-virtual {v6, v7}, Lu3/z;->h(I)I
    ...
    invoke-interface {p1, v6, v5}, Lc2/m;->k(IZ)Z
    ...
    invoke-static {v1, v6}, Lx1/u2;->a(Ljava/lang/String;Ljava/lang/Throwable;)Lx1/u2;
...
.method private k(JZ)V
    ...
    :cond_3
    invoke-direct {p0, p1, p2, v2}, Lm2/h;->h(JZ)Lc2/b0;

    move-result-object p1

    invoke-interface {p3, p1}, Lc2/n;->p(Lc2/b0;)V
...
.method private l(Lc2/m;)I
    ...
    :goto_0
    iget-object v2, p0, Lm2/h;->d:Lu3/a0;
    ...
    invoke-interface {p1, v2, v0, v3}, Lc2/m;->o([BII)V

    iget-object v2, p0, Lm2/h;->d:Lu3/a0;

    invoke-virtual {v2, v0}, Lu3/a0;->R(I)V
    ...
    invoke-interface {p1, v1}, Lc2/m;->p(I)V
    ...
    invoke-virtual {v2, v3}, Lu3/a0;->S(I)V
    ...
    invoke-interface {p1, v2}, Lc2/m;->p(I)V
...
.method public c(Lc2/n;)V
    ...
    invoke-virtual {v0, p1, v1}, Lm2/i;->c(Lc2/n;Lm2/i0$d;)V
...
.method public g(Lc2/m;Lc2/a0;)I
    ...
    invoke-direct {p0, p1}, Lm2/h;->e(Lc2/m;)V

    :cond_2
    iget-object p2, p0, Lm2/h;->c:Lu3/a0;
    ...
    invoke-interface {p1, p2, v4, v2}, Lc2/m;->b([BII)I
    ...
    :goto_2
    invoke-direct {p0, v0, v1, v2}, Lm2/h;->k(JZ)V
    ...
    invoke-virtual {p2, v4}, Lu3/a0;->R(I)V
    ...
    invoke-virtual {p1, v0, v1, p2}, Lm2/i;->e(JI)V
    ...
    invoke-virtual {p1, p2}, Lm2/i;->b(Lu3/a0;)V
...
.method public j(Lc2/m;)Z
    ...
    :cond_0
    iget-object v5, p0, Lm2/h;->d:Lu3/a0;
    ...
    invoke-interface {p1, v5, v1, v6}, Lc2/m;->o([BII)V

    iget-object v5, p0, Lm2/h;->d:Lu3/a0;

    invoke-virtual {v5, v1}, Lu3/a0;->R(I)V

    iget-object v5, p0, Lm2/h;->d:Lu3/a0;

    invoke-virtual {v5}, Lu3/a0;->K()I
    ...
    iget-object v5, p0, Lm2/h;->e:Lu3/z;

    const/16 v6, 0xe

    invoke-virtual {v5, v6}, Lu3/z;->p(I)V

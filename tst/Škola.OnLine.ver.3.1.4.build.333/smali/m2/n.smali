...
.method constructor <init>(Lm2/k0;)V
    ...
    :goto_0
    iput-object p1, p0, Lm2/n;->d:Lu3/a0;
...
.method private static f(Lm2/n$a;Ljava/lang/String;)Landroid/util/Pair;
    .locals 8
    ...
    :goto_1
    new-instance v6, Lx1/n1$b;

    invoke-direct {v6}, Lx1/n1$b;-><init>()V

    invoke-virtual {v6, p1}, Lx1/n1$b;->U(Ljava/lang/String;)Lx1/n1$b;

    move-result-object p1

    const-string v6, "video/mpeg2"

    invoke-virtual {p1, v6}, Lx1/n1$b;->g0(Ljava/lang/String;)Lx1/n1$b;

    move-result-object p1

    invoke-virtual {p1, v2}, Lx1/n1$b;->n0(I)Lx1/n1$b;

    move-result-object p1

    invoke-virtual {p1, v4}, Lx1/n1$b;->S(I)Lx1/n1$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Lx1/n1$b;->c0(F)Lx1/n1$b;
    ...
    invoke-virtual {p1, v1}, Lx1/n1$b;->V(Ljava/util/List;)Lx1/n1$b;
...
.method public b(Lu3/a0;)V
    ...
    invoke-interface {v4, v6, v5}, Lc2/e0;->b(Lu3/a0;I)V

    :goto_0
    iget-object v4, v0, Lm2/n;->f:[Z

    invoke-static {v3, v1, v2, v4}, Lu3/w;->c([BII[Z)I
    ...
    invoke-static {v9, v12}, Lm2/n;->f(Lm2/n$a;Ljava/lang/String;)Landroid/util/Pair;
    ...
    check-cast v13, Lx1/n1;

    invoke-interface {v12, v13}, Lc2/e0;->a(Lx1/n1;)V
    ...
    invoke-static {v8, v1}, Lu3/w;->q([BI)I

    move-result v1

    iget-object v8, v0, Lm2/n;->d:Lu3/a0;

    invoke-static {v8}, Lu3/n0;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v9, v1}, Lu3/a0;->P([BI)V
    ...
    iget-object v12, v0, Lm2/n;->d:Lu3/a0;

    invoke-virtual {v1, v8, v9, v12}, Lm2/k0;->a(JLu3/a0;)V
    ...
    invoke-interface/range {v12 .. v18}, Lc2/e0;->e(JIIILc2/e0$a;)V

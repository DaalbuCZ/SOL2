...
.method private synthetic A(Ljava/util/Map;Ly4/j;)V
    .locals 1
    ...
    iget-object v0, p0, Lw8/m;->n:Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method private synthetic B(Ljava/util/Map;Ly4/j;)V
    .locals 3
...
.method private synthetic C(Ljava/util/Map;Ly4/j;)V
    .locals 1
...
.method private synthetic D(Ljava/util/Map;Ly4/j;)V
    .locals 2
    ...
    iget-object v1, p0, Lw8/m;->n:Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method private static synthetic E(Lt8/k$d;Ly4/i;)V
    .locals 2
...
.method private synthetic F(Ljava/util/Map;Ly4/j;)V
    .locals 3
    ...
    :cond_3
    iget-object p1, p0, Lw8/m;->n:Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method private synthetic G(Ljava/util/Map;Ly4/j;)V
    ...
    invoke-static {p1}, Lw8/m;->m(Ljava/util/Map;)Landroid/os/Bundle;
...
.method private H(Ljava/util/Map;)Ly4/i;
    .locals 3
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/a;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method private I(Ljava/util/Map;)Ly4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/d;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method public static synthetic a(Lw8/m;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lw8/m;->x(Ly4/j;)V

    return-void
.end method

.method public static synthetic b(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->F(Ljava/util/Map;Ly4/j;)V

    return-void
.end method

.method public static synthetic c(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->G(Ljava/util/Map;Ly4/j;)V

    return-void
.end method

.method public static synthetic d(Lt8/k$d;Ly4/i;)V
    .locals 0

    invoke-static {p0, p1}, Lw8/m;->E(Lt8/k$d;Ly4/i;)V

    return-void
.end method

.method public static synthetic e(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->A(Ljava/util/Map;Ly4/j;)V

    return-void
.end method

.method public static synthetic f(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->y(Ljava/util/Map;Ly4/j;)V

    return-void
.end method

.method public static synthetic g(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->D(Ljava/util/Map;Ly4/j;)V

    return-void
.end method

.method public static synthetic h(Lw8/m;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lw8/m;->w(Ly4/j;)V

    return-void
.end method

.method public static synthetic i(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->B(Ljava/util/Map;Ly4/j;)V

    return-void
.end method

.method public static synthetic j(Lw8/m;Ljava/util/Map;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lw8/m;->C(Ljava/util/Map;Ly4/j;)V
...
.method public static synthetic k(Ly4/j;)V
    ...
    invoke-static {p0}, Lw8/m;->v(Ly4/j;)V

    return-void
.end method

.method public static synthetic l(Lw8/m;Ly4/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lw8/m;->z(Ly4/j;)V
...
.method private static m(Ljava/util/Map;)Landroid/os/Bundle;
    ...
    invoke-static {v6}, Lw8/m;->m(Ljava/util/Map;)Landroid/os/Bundle;
    ...
    invoke-static {v3}, Lw8/m;->m(Ljava/util/Map;)Landroid/os/Bundle;
...
.method private n()Ly4/i;
    ...
    invoke-direct {v2, p0, v0}, Lw8/j;-><init>(Lw8/m;Ly4/j;)V
...
.method private o(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/f;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method private p()Ly4/i;
    ...
    invoke-direct {v2, p0, v0}, Lw8/l;-><init>(Lw8/m;Ly4/j;)V
...
.method private q(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/e;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method private r(Ljava/util/Map;)Ly4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/h;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method private s(Ljava/util/Map;)Ly4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/i;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method private t(Ljava/util/Map;)Ly4/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, v0}, Lw8/g;-><init>(Lw8/m;Ljava/util/Map;Ly4/j;)V
...
.method private u(Lt8/c;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p2, p0, Lw8/m;->n:Lcom/google/firebase/analytics/FirebaseAnalytics;

    new-instance p2, Lt8/k;

    const-string v0, "plugins.flutter.io/firebase_analytics"

    invoke-direct {p2, p1, v0}, Lt8/k;-><init>(Lt8/c;Ljava/lang/String;)V

    iput-object p2, p0, Lw8/m;->o:Lt8/k;

    invoke-virtual {p2, p0}, Lt8/k;->e(Lt8/k$c;)V
...
.method private static synthetic v(Ly4/j;)V
    .locals 1
...
.method private synthetic w(Ly4/j;)V
    ...
    invoke-direct {v0, p0}, Lw8/m$a;-><init>(Lw8/m;)V
...
.method private synthetic x(Ly4/j;)V
    .locals 1

    :try_start_0
    iget-object v0, p0, Lw8/m;->n:Lcom/google/firebase/analytics/FirebaseAnalytics;

    invoke-virtual {v0}, Lcom/google/firebase/analytics/FirebaseAnalytics;->a()Ly4/i;
...
.method private synthetic y(Ljava/util/Map;Ly4/j;)V
    .locals 2
...
.method public didReinitializeFirebaseCore()Ly4/i;
    ...
    invoke-direct {v2, v0}, Lw8/b;-><init>(Ly4/j;)V
...
.method public getPluginConstantsForFirebaseApp(Lk5/e;)Ly4/i;
    ...
    invoke-direct {v1, p0, p1}, Lw8/k;-><init>(Lw8/m;Ly4/j;)V
...
.method public onAttachedToEngine(Lk8/a$b;)V
    ...
    invoke-direct {p0, v0, p1}, Lw8/m;->u(Lt8/c;Landroid/content/Context;)V
...
.method public onDetachedFromEngine(Lk8/a$b;)V
    ...
    iget-object p1, p0, Lw8/m;->o:Lt8/k;
    ...
    iput-object v0, p0, Lw8/m;->o:Lt8/k;
...
.method public onMethodCall(Lt8/j;Lt8/k$d;)V
    ...
    invoke-direct {p0, p1}, Lw8/m;->s(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {p0, p1}, Lw8/m;->r(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {p0, p1}, Lw8/m;->t(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {p0, p1}, Lw8/m;->o(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {p0, p1}, Lw8/m;->I(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {p0, p1}, Lw8/m;->q(Ljava/util/Map;)Ly4/i;
    ...
    invoke-direct {p0, p1}, Lw8/m;->H(Ljava/util/Map;)Ly4/i;
    ...
    :pswitch_7
    invoke-direct {p0}, Lw8/m;->p()Ly4/i;
    ...
    :pswitch_8
    invoke-direct {p0}, Lw8/m;->n()Ly4/i;
    ...
    invoke-direct {v0, p2}, Lw8/c;-><init>(Lt8/k$d;)V

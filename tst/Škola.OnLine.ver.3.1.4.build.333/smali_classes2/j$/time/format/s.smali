...
.method g()Lj$/time/chrono/f;
    ...
    iget-object v0, v0, Lj$/time/format/y;->c:Lj$/time/chrono/f;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/time/format/s;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/f;
...
.method q()V
    ...
    iget-object v3, v1, Lj$/time/format/y;->c:Lj$/time/chrono/f;

    iput-object v3, v2, Lj$/time/format/y;->c:Lj$/time/chrono/f;
...
.method s(Lj$/time/format/z;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    .locals 2
    ...
    iget-object v1, v1, Lj$/time/format/y;->c:Lj$/time/chrono/f;

    if-nez v1, :cond_0

    iget-object v1, p0, Lj$/time/format/s;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v1}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/f;
    ...
    .line 2
    :cond_0
    iput-object v1, v0, Lj$/time/format/y;->c:Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/y;->o(Lj$/time/format/z;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;

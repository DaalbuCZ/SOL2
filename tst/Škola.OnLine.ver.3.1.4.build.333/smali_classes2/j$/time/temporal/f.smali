...
# virtual methods
.method public a(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/z;)Lj$/time/temporal/TemporalAccessor;
    .locals 18
    ...
    :cond_0
    invoke-interface {v3}, Lj$/time/temporal/o;->c()Lj$/time/temporal/z;
    ...
    invoke-static {v4, v9, v10}, Lj$/time/h;->y(III)Lj$/time/h;
    ...
    invoke-virtual {v4, v10, v11}, Lj$/time/h;->E(J)Lj$/time/h;
    ...
    invoke-static {v12, v13, v14, v15}, Lj$/time/c;->e(JJ)J

    move-result-wide v16

    div-long v9, v16, v14

    invoke-virtual {v4, v9, v10}, Lj$/time/h;->E(J)Lj$/time/h;
    ...
    :cond_2
    invoke-static {v7, v8, v9, v10}, Lj$/time/c;->e(JJ)J

    move-result-wide v6

    invoke-virtual {v4, v6, v7}, Lj$/time/h;->E(J)Lj$/time/h;

    move-result-object v2

    invoke-virtual {v2, v5, v12, v13}, Lj$/time/h;->I(Lj$/time/temporal/o;J)Lj$/time/h;
    ...
    invoke-static {v4}, Lj$/time/temporal/h;->p(Lj$/time/h;)Lj$/time/temporal/z;
    ...
    :cond_6
    invoke-virtual/range {p0 .. p0}, Lj$/time/temporal/f;->c()Lj$/time/temporal/z;
    ...
    invoke-virtual {v4, v7, v8}, Lj$/time/h;->E(J)Lj$/time/h;

    move-result-object v2

    int-to-long v6, v6

    invoke-virtual {v2, v5, v6, v7}, Lj$/time/h;->I(Lj$/time/temporal/o;J)Lj$/time/h;
...
.method public b(Lj$/time/temporal/TemporalAccessor;)J
    .locals 2
...
.method public c()Lj$/time/temporal/z;
    .locals 6
...
.method public h(Lj$/time/temporal/TemporalAccessor;)Z
    ...
    .line 1
    invoke-static {p1}, Lj$/time/chrono/d;->b(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/f;
...
.method public i(Lj$/time/temporal/k;J)Lj$/time/temporal/k;
    .locals 2

    invoke-virtual {p0}, Lj$/time/temporal/f;->c()Lj$/time/temporal/z;

    move-result-object v0

    invoke-virtual {v0, p2, p3, p0}, Lj$/time/temporal/z;->b(JLj$/time/temporal/o;)J

    invoke-virtual {p0, p1}, Lj$/time/temporal/f;->b(Lj$/time/temporal/TemporalAccessor;)J

    move-result-wide v0

    invoke-static {p2, p3, v0, v1}, Lj$/time/c;->e(JJ)J

    move-result-wide p2

    sget-object v0, Lj$/time/temporal/b;->WEEKS:Lj$/time/temporal/b;

    invoke-interface {p1, p2, p3, v0}, Lj$/time/temporal/k;->l(JLj$/time/temporal/x;)Lj$/time/temporal/k;
...
.method public k(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/z;
    .locals 1
    ...
    invoke-static {p1}, Lj$/time/temporal/h;->p(Lj$/time/h;)Lj$/time/temporal/z;
